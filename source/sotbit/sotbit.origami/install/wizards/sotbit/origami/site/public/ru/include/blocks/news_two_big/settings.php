...
return [
	'block' =>
		[
			'name' => \Bitrix\Main\Localization\Loc::getMessage('NEWS_TITLE_TWO_BIG'),
			'section' => 'news',
		],
    'fields' =>
		[
	...
	'ext' =>
		[
			...
			'css' =>
				[$_SERVER['DOCUMENT_ROOT'].'/local/templates/.default/components/bitrix/news.list/origami_news_two_big/style.css'
				],
		],
	'style'  =>
		[
