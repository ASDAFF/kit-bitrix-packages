            ...
            <div class="row">
                ...
                ?>
                    <div class="col-xl-3 col-lg-3 col-md-3 col-12">
                        <label class="puzzle_block__form_label">
                            <input
		                            type="<?=$arQuestion["CAPTION"] == GetMessage("SOTBIT_FORM_TEL") ? "tel" : $fieldType?>"
		                            class="feedback_block__form_input <?= ( $arQuestion['CAPTION'] == GetMessage("SOTBIT_FORM_TEL") ? "js-phone" : "" ) ?>"
                ...
                <div class="feedback_block__compliance">
                    <div class="cntr">
                        ...
                        <a class="feedback_block__compliance_link fonts__middle_comment" href="<?=\Sotbit\Origami\Helper\Config::get('CONFIDENTIAL_PAGE')?>"><?=GetMessage('SOTBIT_FORM_I_AGREE2')?></a>
                    </div>
                </div>
            </div>
