...
<div class="puzzle_block news-block__wrapper main-container stock-wrapper__right-navigation">
    ...
    <div class="news_block_three ">
        <div class="news_block_three__others">
        ...
        <!-- <div class="news_block_three__wrapper"> -->
        <?
        $i = 0;
        ...
        <?foreach(array_slice($arResult["ITEMS"], 0, 7) as $arItem):?>
            ...
            ?>
            <?if($i <= 2):?>
                <div class="news_block_three__item" id="<?=$this->GetEditAreaId($arItem['ID']);?>"  data-timer="timerID_<?=$blockID?>">
