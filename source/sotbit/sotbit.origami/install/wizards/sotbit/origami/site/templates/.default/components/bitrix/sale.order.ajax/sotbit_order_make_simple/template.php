            ...
            else
            {
                ...
                else
                {
                    ...
                    <div class="row info_order no-padding">
                        ...
                        {
                            ?><div class="col-xl-4 col-lg-4 col-md-6 mb-4"><?include($_SERVER["DOCUMENT_ROOT"].$templateFolder."/delivery.php");?></div><?
                            ?><div class="col-xl-4 col-lg-4 col-md-12 mb-4"><?include($_SERVER["DOCUMENT_ROOT"].$templateFolder."/paysystem.php");?></div><?
                        }
                        else
                        {
                            ?><div class="col-xl-4 col-lg-4 col-md-6 mb-4"><?include($_SERVER["DOCUMENT_ROOT"].$templateFolder."/paysystem.php");?></div><?
                            ?><div class="col-xl-4 col-lg-4 col-md-12 mb-4"><?include($_SERVER["DOCUMENT_ROOT"].$templateFolder."/delivery.php");?></div><?
                        }
                        ?>
                    </div>
                    <?
                    ...
                    <div class="price_order_block">
                        ...
                        else
                        {
                            ?>
                            <div class="price_order_block__item fonts__small_text">
                                <?=Loc::getMessage("SOA_TEMPL_SUM_IT")?> <b class="sotbit_soa_order_total_price"><?=$arResult["ORDER_TOTAL_PRICE_FORMATED"]?></b>
                            </div>
                            <?
                        }
                        ?>
