            ...
            (function () {
                    ...
                    function setMobileFilterEvents() {
                        ...
                        function addAllTitles() {
                            if (document.querySelectorAll(".used-now-title").length === 0) {
                                ...
                                for (let i = 0; i < checkBoxWrappers.length; i++) {
                                    if (checkBoxWrappers[i].querySelectorAll(".radio_container").length === 0) {
                        ...
                        function reset() {
                            ...
                            for (let i =0; i < usedNowTitles; i++) {
                                usedNowTitles[i].style.display = "none";
                                notUsedNowTitles[i].style.display = "none";
                            }
                            ...
                            let wrappers = document.querySelectorAll(".catalog_content__filter_horizon_item_wrapper");
...
$(document).ready(function () {
    ...
    let mobileFilter = document.querySelector('.mobile_filter_form');
    mobileFilter.addEventListener('click', function (evt) {
