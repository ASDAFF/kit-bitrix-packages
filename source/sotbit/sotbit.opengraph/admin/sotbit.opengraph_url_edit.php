...
$aMenu = array(
    array(
        ...
        "ICON" => "btn_list",
        "LINK" => '/bitrix/admin/sotbit.opengraph_url_list.php?lang='.SITE_ID.(isset($_REQUEST['site']) ? '&site='.$_REQUEST['site'] : '').(isset($_REQUEST['CATEGORY_ID']) ? '&CATEGORY_ID='.$_REQUEST['CATEGORY_ID'] : ''),
    ),);
