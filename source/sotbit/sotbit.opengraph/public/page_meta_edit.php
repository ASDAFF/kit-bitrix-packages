...
require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/sotbit.opengraph/include.php");
...
?>
    ...
    <form action="/bitrix/admin/public_sotbit_opengraph_meta_edit.php" name="editor_form" method="post" enctype="multipart/form-data" target="file_edit_form_target" style="margin: 0px; padding: 0px; ">
        <?
        if (CAutoSave::Allowed())
        {
       ...
       /////////////////////////////// form inputs start
        ...
        include($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/sotbit.opengraph/admin/block/og_settings.php");
        ...
        include($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/sotbit.opengraph/admin/block/tw_settings.php");
