...
<div class="select-city__modal-wrap">
    ...
    <input class="select-city__input" type="region-input" name="" id="region-input" placeholder="<?=Loc::getMessage(SotbitRegions::moduleId.'_WRITE_SITY')?>" data-entity="filter-regions">
    ...
    if($regions['REGION_LIST_COUNTRIES']){
        ...
        foreach ($regions['REGION_LIST_COUNTRIES'] as $id => $region){
            ?>
            <div class="select-city__tab_content <?=($id == key($regions['REGION_LIST_COUNTRIES']))?'active':''?>" data-country-id="<?=$id?>" data-entity="tab-content">
                        ...
                        <div class="select-city__list_wrapper_favorites">
                            <div class="select-city__list">
                                ...
                                foreach($regions['FAVORITES'][$id] as $city){
                                    ?>
                                    <p class="select-city__list_item" data-index="<?= $city['ID'] ?>" data-entity="item">
