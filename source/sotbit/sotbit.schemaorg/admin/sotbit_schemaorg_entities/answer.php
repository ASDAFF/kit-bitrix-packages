...
$langPrefix = 'SOTBIT_SCHEMA_ANSWER_';
...
?>
    <tr class="adm-detail-file-row">
        <td colspan="2" style="text-align: center">
            <input type="hidden" name="<?=$key ? $key."[@type]" : "@type"?>" value="Answer"/>
        </td>
    </tr>
<?
...
$tabControl = SotbitSchema::makeSingleDropDownField($tabControl, "parentItem",
    array(
        '' => '...',
        'question' => 'Question',
    ),
...
$tabControl->AddEditField($key ? $key."[upvoteCount]" : "upvoteCount", Loc::getMessage($langPrefix.'upvoteCount'), false, false,
    ( isset($arFields["upvoteCount"]) & !empty($arFields["upvoteCount"]) ? $arFields["upvoteCount"] : "" ));
