...
$langPrefix = 'SOTBIT_SCHEMA_CREATIVEWORK_';
...
<tr class="adm-detail-file-row">
    <td colspan="2" style="text-align: left">
        <input type="hidden" name="<?=$key ? $key."[@type]" : "@type"?>" value="CreativeWork"/>
    </td>
</tr>
<?
...
$tabControl = SotbitSchema::makeMultipleDropDownField($tabControl, "mainEntity",
    array(
        '' => '...',
        'question' => 'Question',
    ),
...
$tabControl = SotbitSchema::makeSingleDropDownField($tabControl, "publisher",
    array(
        '' => '...',
        'organization' => 'Organization',
    ),
    $key, $langPrefix, $arFields);
$tabControl = SotbitSchema::makeSingleDropDownField($tabControl, "accountablePerson",
    array(
        '' => '...',
        'person' => 'Person'
    ),
...
$tabControl = SotbitSchema::makeSingleDropDownField($tabControl, "contentLocation",
    array(
        '' => '...',
        'place' => 'Place'
    ),
...
$tabControl = SotbitSchema::makeSingleDropDownField($tabControl, "contributor",
    ...
    $key, $langPrefix, $arFields);
$tabControl = SotbitSchema::makeSingleDropDownField($tabControl, "copyrightHolder",
    array(
        '' => '...',
        'person' => 'Person',
        'organization' => 'Organization',
...
$tabControl = SotbitSchema::makeSingleDropDownField($tabControl, "editor",
    array(
        '' => '...',
        'person' => 'Person'
    ),
...
$tabControl = SotbitSchema::makeSingleDropDownField($tabControl, "locationCreated",
    array(
        '' => '...',
        'place' => 'Place'
    ),
...
$tabControl = SotbitSchema::makeSingleDropDownField($tabControl, "offers",
    array(
        '' => '...',
        'offer' => 'Offer',
    ),
...
$tabControl = SotbitSchema::makeSingleDropDownField($tabControl, "translationOfWork",
    array(
        '' => '...',
