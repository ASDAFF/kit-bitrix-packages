...
$langPrefix = 'SOTBIT_SCHEMA_ENTRYPOINT_';
...
?>
    <tr class="adm-detail-file-row">
        <td colspan="2" style="text-align: center">
            <input type="hidden" name="<?=$key ? $key."[@type]" : "@type"?>" value="EntryPoint"/>
        </td>
    </tr>
<?
$tabControl->EndCustomField("type_BLOCK");
$tabControl->AddEditField($key ? $key."[urlTemplate]" : "urlTemplate", GetMessage($langPrefix.'urlTemplate'), true, false,
    ( isset($arFields["urlTemplate"]) & !empty($arFields["urlTemplate"]) ? $arFields["urlTemplate"] : "" ));
