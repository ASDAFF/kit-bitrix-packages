...
{
    if (file_exists(dirname(__FILE__) . '/sotbit_schemaorg_entities/' . strtolower($arFields["ENTITIES"]["@type"]) . '.php')) {
        $path = dirname(__FILE__) . '/sotbit_schemaorg_entities/' . strtolower($arFields["ENTITIES"]["@type"]) . '.php';
