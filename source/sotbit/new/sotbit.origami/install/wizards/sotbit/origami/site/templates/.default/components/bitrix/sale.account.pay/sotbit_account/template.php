...
else
{
								...
								<div class="form-group row" style="margin-bottom: 0;">
									...
									$inputElement = "
										<div class='col-9'>
											...
											class='form-control sale-acountpay-input' value='0.00' "
									...
									$labelWrapper = "<div class='col-3'><label class='control-label input-lg input-lg'>".$tempCurrencyRow."</label></div>";
						...
						<div>
							<div class="sale-acountpay-pp row">
								<div class="col-md-10 col-sm-10 col-xs-12 ">
									...
									{
										?>
										<div class="sale-acountpay-pp-company col-lg-3 col-sm-4 col-xs-6 col-6 <?= ($key == 0) ? 'bx-selected' :""?>">
	...
	else
	{
		...
		<form method="post" name="buyMoney">
			<?
