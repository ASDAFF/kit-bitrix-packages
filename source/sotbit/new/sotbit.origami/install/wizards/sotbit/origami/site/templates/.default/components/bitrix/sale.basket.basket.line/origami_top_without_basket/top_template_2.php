...
if (!$arResult["DISABLE_USE_BASKET"])
{
	...
	?>
	<a class="header-two__basket-favorites <?=($arResult["NUM_PRODUCTS_DELAY"] > 0)?'active':''?>" href="<?=$arParams['PATH_TO_BASKET'].'#favorit'?>" <?if($arResult["NUM_PRODUCTS_DELAY"]>0):?><?endif?>>
	...
	<a class="header-two__basket-buy <?=($arResult['NUM_PRODUCTS'] > 0)?'active':''?>" href="<?=$arParams['PATH_TO_BASKET']?>" <?if($arResult["NUM_PRODUCTS"]>0):?><?endif;?>>
