...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
		...
		editTotalBlock: function()
		{
			...
			{
				this.totalInfoBlockNode.appendChild(this.createTotalUnit(BX.message('SOA_SUM_IT'),
                    this.options.showPriceWithoutDiscount ?
                        total.ORDER_TOTAL_PRICE_FORMATED +'<br><span class="bx-price-old">' + total.PRICE_WITHOUT_DISCOUNT + '</span>':
		...
		createTotalUnit: function(name, value, params)
		{
			...
			if (params.total)
			{
				className += ' bx-soa-cart-total-line-total clearfix';
			}
...
//
//
//     let sidePanelMainOrder = document.querySelector('.main-order__content');
...
//     }
//
//     console.log(getHeight(sidePanelMainOrder))
// });
