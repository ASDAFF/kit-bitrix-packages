...
BX.Catalog.SetConstructor = (function()
{
	...
	SetConstructor.prototype.deleteFromSet = function()
	{
		...
		if (target && target.hasAttribute('data-role') && target.getAttribute('data-role') == 'set-delete-btn')
		{
			...
			newSliderNode = BX.create("div", {
				...
				// 							html: itemBasketQuantity + ' ' + itemMeasure + ' <span>' + itemPrintPrice + '</span>'
				// 						}),
				// 						BX.create("div", {
				// 							attrs: {
            ...
            item.classList.add('setItemDisabled');
            var btnDel = item.querySelector('.bx-added-item-delete');
            btnDel.classList.add('bx-added-item-add');
            btnDel.classList.remove('bx-added-item-delete');
            btnDel.setAttribute('data-role', 'set-add-btn');

            var tempPrice = item.getAttribute('data-price');
            item.removeAttribute('data-price');
            item.setAttribute('price', tempPrice);
            var tempOldPrice = item.getAttribute('data-old-price');
            item.removeAttribute('data-old-price');
            item.setAttribute('old-price', tempOldPrice);
            var tempDiffPrice = item.getAttribute('data-diff-price');
            item.removeAttribute('data-diff-price');
            item.setAttribute('diff-price', tempDiffPrice);
            var tempDiffPrice = item.getAttribute('data-quantity');
            item.removeAttribute('data-quantity');
            item.setAttribute('quantity', tempDiffPrice);
            ...
            if (target && target.hasAttribute('data-role') && target.getAttribute('data-role') == 'set-add-btn') {
                ...
                item.classList.remove('setItemDisabled');
                var btnDel = item.querySelector('.bx-added-item-add');
                btnDel.classList.add('bx-added-item-delete');
                btnDel.classList.remove('bx-added-item-add');
                btnDel.setAttribute('data-role', 'set-delete-btn');

                var tempPrice = item.getAttribute('price');
                item.removeAttribute('price');
                item.setAttribute('data-price', tempPrice);
                var tempOldPrice = item.getAttribute('old-price');
                item.removeAttribute('old-price');
                item.setAttribute('data-old-price', tempOldPrice);
                var tempDiffPrice = item.getAttribute('diff-price');
                item.removeAttribute('diff-price');
                item.setAttribute('data-diff-price', tempDiffPrice);
                var tempDiffPrice = item.getAttribute('quantity');
                item.removeAttribute('quantity');
                item.setAttribute('data-quantity', tempDiffPrice);
	...
	// 	{
			...
			// 						},
			// 						// html: itemPrintPrice + ' * ' + itemBasketQuantity + itemMeasure
            //                         html: itemBasketQuantity + ' ' + itemMeasure + '<span class="bx-added-item-new-price-value">' + itemPrintPrice + '</span>'
            //                     }),
			// 					BX.create("br"),
			// 					BX.create("span", {
			// 						attrs: {
