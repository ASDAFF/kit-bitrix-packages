...
return [
    'block' =>
        [
            'name' => \Bitrix\Main\Localization\Loc::getMessage('PROMOTIONS_TITLE_IMAGES_AND_LIST_RIGHT'),
            'section' => 'promotions',
        ],
    'fields' =>
        [
    ...
    'ext' =>
        [
            ...
            'css' =>
                [$_SERVER['DOCUMENT_ROOT'].'/local/templates/.default/components/bitrix/news.list/origami_promotions_images_and_list_right/style.css'
                ],
        ],
    'style'  =>
        [
