...
return [
	'block' =>
		[
			'name' => \Bitrix\Main\Localization\Loc::getMessage('PROMOTIONS_TITLE_VERTICAL'),
			'section' => 'promotions',
		],
    'fields' =>
		[
	...
	'ext' =>
		[
			...
			'css' =>
				[$_SERVER['DOCUMENT_ROOT'].'/local/templates/.default/components/bitrix/news.list/origami_promotions_vertical/style.css'
				],
		],
    'style'  =>
        [
