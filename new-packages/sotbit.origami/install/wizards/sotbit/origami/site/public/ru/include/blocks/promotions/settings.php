...
return [
	'block' =>
		[
			'name' => \Bitrix\Main\Localization\Loc::getMessage('PROMOTIONS_TITLE'),
			'section' => 'promotions',
		],
	'fields' =>
		[
	...
	'ext' =>
		[
			...
			'css' =>
				[$_SERVER['DOCUMENT_ROOT'].'/local/templates/.default/components/bitrix/news.list/origami_promotions_hybrid/style.css'
				],
		],
    'style'  =>
        [
