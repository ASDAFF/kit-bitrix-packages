...
return [
	'block' =>
		[
			'name' => \Bitrix\Main\Localization\Loc::getMessage('BLOG_TITLE_SQUARE_RIGHT'),
			'section' => 'blog',
		],
    'fields' =>
		[
	...
	'ext' =>
		[
			...
			'css' =>
				[$_SERVER['DOCUMENT_ROOT'].'/local/templates/.default/components/bitrix/news.list/origami_blog_square_right/style.css',
				],
		],
	'style'  =>
		[
