...
else
{
	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			<!--	MAIN BLOCK	-->
			<div class="col-md-12 col-12 bx-soa">
				...
				<? if ($arParams['BASKET_POSITION'] === 'before'): ?>
					...
					<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
						<div class="bx-soa-section-title-container">
							...
							<div class="col-xs-12 col-sm-3 text-md-right"><a href="javascript:void(0)" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a></div>
						</div>
						<div class="bx-soa-section-content container-fluid"></div>
					</div>
				<? endif ?>
				...
				<div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active">
					<div class="bx-soa-section-title-container">
						...
						<div class="col-xs-12 col-sm-3 text-md-right"><a href="" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a></div>
					</div>
					<div class="bx-soa-section-content container-fluid"></div>
				</div>
            ...
            <div class="bx-sidebar row">
			<!--	SIDEBAR BLOCK	-->
                <div id="bx-soa-total" class="col-md-12 col-12 bx-soa-sidebar">
	...
	<script>
        ...
        function f1() { //todo 'test'
            BX.Sale.OrderAjaxComponent.refreshOrder(<?=CUtil::PhpToJSObject($arResult['JS_DATA'])?>);
        }
	</script>
	<script>
		<?
