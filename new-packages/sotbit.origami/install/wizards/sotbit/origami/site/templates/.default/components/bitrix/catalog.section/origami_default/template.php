		    ...
		    foreach($arResult['ITEMS'] as $item)
			{
				...
				<div
                    ...
                    class="product_card__block_item <?
                        if($arParams["TEMPLATE_LIST_VIEW_DEFAULT"] == "list"):?>
                        product_card__block_item--row <?=( $arParams['MOBILE_VIEW_MINIMAL'] == 'Y' ? "product_card__block_item--row-min" : "" )?>

                        <?elseif($arParams["TEMPLATE_LIST_VIEW_DEFAULT"] == "column"):?>
                        product_card__block_item--column

                        <?else:?>product_card__block_item-<?=$arParams['LINE_ELEMENT_COUNT']?><?endif;
                    ?>"
                >
					<?
                    ...
                    elseif ($arParams["TEMPLATE_LIST_VIEW_DEFAULT"] == "column")
                        ...
                        $templateType = $arParams["VARIANT_LIST_VIEW"];
