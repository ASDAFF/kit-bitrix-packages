...
Asset::getInstance()->addcss(SITE_DIR . "include/sotbit_origami/contact_page_block/regional_office_5/style.css");
Asset::getInstance()->addjs(SITE_DIR . "local/templates/sotbit_origami/assets/plugin/fix-block/script.js");
Asset::getInstance()->addjs(SITE_DIR . "local/templates/sotbit_origami/assets/plugin/weel/script.js");
Asset::getInstance()->addcss(SITE_DIR . "local/templates/sotbit_origami/assets/plugin/weel/style.css");
Asset::getInstance()->addjs(SITE_DIR . "include/sotbit_origami/contact_page_block/regional_office_5/script.js");
...
?>
<div class="regional_office-wrapper">
    <div class="regional-office-wrapper">
            ...
            <div class="contacts-content-size-wrapper">
                ...
                if ($i > 1) {
                    ...
                    <div class="wheel-buttons">
                        <ul class="regions-select-buttons">
                            <?
                            foreach ($arSections as $section) {
                                if ($section['CONTENT_AVAILABILITY'] && $section['ACTIVE'] == 'Y') {
                                    ?>
        ...
        foreach ($arSections as $section) {
            if ($section['CONTENT_AVAILABILITY'] && $section['ACTIVE'] == 'Y') {
                ...
                ?>
                <div class="contacts-content-regional-wrapper__background">
                    <div class="contacts-header-five-wrapper">
                        <div class="contacts-content-regional-wrapper contacts-content-size-wrapper">
                                                    ...
                                                    <div class="office-image-address-wrapper">
                                                        <div class="office-image">
                                                            ...
                                                            if ($pathImg) {
                                                                ...
                                                                ?>
                                                                <img
                                                                    src="<?= SITE_DIR ?>include/sotbit_origami/contact_page_block/regional_office/default-no-photo.jpg"
                                                                    alt="">
                                                                <?
                                                            }
                                                            ?>
                                                        </div>
                                                        <div class="regional-address_with-image">
                                                            <? if ($item['NAME'] || $arPropsItem['ADDRESS']['VALUE']): ?>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="regional-subway">
                                                                ...
                                                                <? if ($arPropsItem['METRO']): ?>
                                                                    <? if (count($arPropsItem['METRO']) > 1):
                                                                        foreach ($arPropsItem['METRO'] as $metro)
                                                                            ?><span><?= $metro['VALUE'] ?></span><?
                                                                    else:?>
                                                                        <span><?= $arPropsItem['METRO'][0]['VALUE']; ?></span>
                                                                    <?endif; ?>
                                                                <?endif; ?>
                                        ...
                                        <div class="manager-photo-wrapper">
                                            ...
                                            <div class="manager-name-wrapper-mobile">
                                                ...
                                                if ($usDate['WORK_POSITION']): ?>
                                                    <span
                                                        class="manager-information-title"><?= $usDate['WORK_POSITION'] ?></span>
                                                <? endif; ?>
                                                <?
                                                if ($usDate['NAME'] || $usDate['LAST_NAME']): ?>
                                                    <span
                                                        class="manager-information-name"><?= $usDate['NAME'] . ' ' . $usDate['LAST_NAME'] ?></span>
                                                <? endif; ?>
                                            </div>
                                        </div>
                                                    ...
                                                    if ($usDate['UF_USER_WORK_EMAIL']): ?>
                                                        <div class="manager-email">
                                                            <a href="mailto:<?= $usDate['UF_USER_WORK_EMAIL']; ?>">
                                                                ...
                                                                <span><?= $usDate['UF_USER_WORK_EMAIL']; ?></span>
                                                            </a>
                                                        </div>
                                                    <? endif; ?>
                                                </div>
