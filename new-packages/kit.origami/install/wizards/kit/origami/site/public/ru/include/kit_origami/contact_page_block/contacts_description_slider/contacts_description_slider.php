...
<div class="contact-slider-description">
    ...
    <div class="contact-description-slider-wrapper swiper-container">
        ...
        <div class="btn-slider-main <?=$sliderButtons?> btn-slider-main--prev"></div>
    </div>
</div>
...
<script>
    ...
    let swiper_contact_description = new Swiper('.contact-description-slider-wrapper', {
        slidesPerView: 'auto',
        spaceBetween: 10,
        watchOverflow: true,
        freeMode: true,
        ...
        loop: true,
        navigation: {
            nextEl: '.contact-slider-description .btn-slider-main--next',
            prevEl: '.contact-slider-description .btn-slider-main--prev',
        },
        breakpoints: {
            400: {
                spaceBetween: 20,
