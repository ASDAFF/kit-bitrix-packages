...
$templateData = [
    ...
    'OFFERS_ID' => (isset($arResult["OFFERS_ID"])) ? $arResult["OFFERS_ID"] : array()
];
...
?>
    <div class="quick-view">
        <div id="<?= $itemIds['ID'] ?>" class="elem_check_basket_<?= $arResult['ID'] ?>">
            ...
            {
                ?>
                <h1 class="product_preview_title js-product-name"><?= $name ?></h1>
                <?
            }
            ?>
                ...
                <div class="product-preview-photo-block-wrapper">
                    <div class="product-preview-photo-block">
                        <div id="<?= $itemIds['BIG_SLIDER_ID'] ?>"
                            ...
                            <div class="product-item-preview-slider-container swiper-container">
                                ...
                                <div class="product-item-preview-slider-block swiper-container" data-entity="images-slider-block">
                                    <div class="product-item-preview-slider-images-container swiper-wrapper" data-entity="images-container">
                                        <?
                                        if (!empty($actualItem['MORE_PHOTO']))
                                        {
                                            foreach ($actualItem['MORE_PHOTO'] as $key => $photo)
                                            {
                                                ...
                                                $photoBig = ($photo['BIG'])
                                                    ...
                                                    : $photo['ORIGINAL'];
                                                ?>
                                            <div class="swiper-slide" data-entity="image-wrapper">
                                                <div
                                                ...
                                                if($key == 0 && $arResult['VIDEO'])
                                                {
                                                    ...
                                                    {
                                                        ?>
                                                        <div class="preview-big-video swiper-slide" data-value="<?=$i?>">
                                                            <?=$video?>
                                                        </div>
                                                        <?
                                                    }
                            ...
                            if($showSliderControls)
                            {
                                if($haveOffers)
                                {
                                    foreach($arResult['OFFERS'] as $keyOffer => $offer)
                                    {
                                        ...
                                        ?>
                                        <div class="product-item-preview-slider-controls-block swiper-container gallery-thumbs" id="<?= $itemIds['SLIDER_CONT_OF_ID'].$offer['ID'] ?>" style="display: <?= $strVisible ?>;">
                                            ...
                                            foreach ($offer['MORE_PHOTO'] as $keyPhoto => $photo)
                                            {
                                                ...
                                                ?>
                                                <div class="product-item-preview-slider-controls-image swiper-slide<?= ($keyPhoto
                                                == 0 ? ' active' : '') ?>"
                                                ...
                                                if($keyPhoto == 0 && $arResult['VIDEO'])
                                                {
                                                    ...
                                                    {
                                                        ?>
                                                        <div class="product-item-preview-slider-controls-video swiper-slide" data-entity="video" data-value="<?=$i?>">
                                    ...
                                    ?>
                                    <div class="product-item-preview-slider-controls-block swiper-container gallery-thumbs" id="<?= $itemIds['SLIDER_CONT_ID'] ?>">
                                        <div class="swiper-wrapper">
                                        <?
                                        if(!empty($actualItem['MORE_PHOTO']))
                                        {
                                            foreach ($actualItem['MORE_PHOTO'] as $key => $photo)
                                            {
                                                $photoSmall = ($photo['SMALL']) ? $photo['SMALL'] : $photo['ORIGINAL'];
                                                ?>
                                                <div class="product-item-preview-slider-controls-image swiper-slide<?= ($key
                                                == 0 ? ' active' : '') ?>"
                                                    data-entity="slider-control"
                ...
                <div class="product_preview_description">
                    ...
                    <div class="product_preview_info">
                                    ...
                                    <div id="<?= $itemIds['TREE_ID'] ?>">
                                        ...
                                        foreach ($arResult['SKU_PROPS'] as $code => $skuProperty)
                                        {
                                            ...
                                            if ($code == Config::get('COLOR'))
                                            {
                                                ...
                                                ?>
                                                <div class="product-preview-info-block-main-property" data-entity="sku-line-block">
                                                    ...
                                                    <div class="block-property-text">
                                                        ...
                                                        if (Config::get('PROP_DISPLAY_MODE_'.$template) != 'dropdown'):?>
                                                            ...
                                                            foreach($skuProperty['VALUES'] as &$value)
                                                            {
                                                                ...
                                                                $value['NAME'] = htmlspecialcharsbx($value['NAME']);
                                                                ?>
                                                                <div class="block-property-text-item block-property <?=($value['XML_ID'] == $actualItem['PROPERTIES'][$code]['VALUE'])?'active':''?>
                                                                        <?
                                                                if($canNotBuyOffers)
                                                                {
                                                                    foreach($canNotBuyOffers as $notBuyOffer)
                                                        ...
                                                        <? else:?>
                                                            <div class="dropdown-props-wrapper">
                                                                <div class="dropdown-btn angle-down" onclick="window.dropdownToggle(this)">
                                                                    <?= $skuProperty['NAME'] ?>
                                                                </div>
                        ...
                        <div class="product_preview-btn-block">
                            ...
                            <div class="product_preview_info_block">
                                ...
                                <?
                                    ...
                                    <? } ?>
                                    <div id="<?= $itemIds['BASKET_ACTIONS_ID'] ?>" class="preview-basket-wrapper" style="display:    <?= ($actualItem['CAN_BUY']
                                            ? '' : 'none') ?>;">
                                        <?
                                        if ($showAddBtn)
                                        {
                                ...
                                <? if (Config::get('SHOW_WANT_GIFT_'.$template) != 'N'): ?>
                                    ...
                                    {
                                        $priceProduct = $arResult['ITEM_PRICES'][0]['PRINT_PRICE'];
                                        if ($arResult['DISCOUNT'] > 0)
                                        {
                                            $oldPriceProduct = $arResult['ITEM_PRICES'][0]['PRINT_BASE_PRICE'];
                                        }
                                    }
                                    ?>
                        ...
                        <?if (Config::get('SHOW_NAVIGATION_'.$template) == 'Y'):?>
                            <div class="product_preview__nav-items">
                                <a href="javascript:void(0);" class="product_preview__nav-prev" onclick='quickViewPreview("<?=$arResult['PREV_ITEM']['DETAIL_PAGE_URL']?>");'>
                                    <div class="product_preview__nav-wrapper">
                                        ...
                                        <div class="product_preview__nav-content product_preview__nav-content--prev">
                                            <?if($arResult['PREV_ITEM']['PREVIEW_PICTURE'] || $arResult['PREV_ITEM']['DETAIL_PICTURE']):?>
                                                <div class="product_preview__nav-img">
                                            ...
                                            <?endif;?>
                                            <div class="product_preview__nav-description">
                                                <p class="product_preview__nav-title-slide"><?=Loc::getMessage('DETAIL_PREV_ITEM');?></p>
                                                <p class="product_preview__nav-item-name"><?=$arResult['PREV_ITEM']['NAME']?></p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                <a href="javascript:void(0);" class="product_preview__nav-next" onclick='quickViewPreview("<?=$arResult['NEXT_ITEM']['DETAIL_PAGE_URL']?>");'>
                                    <div class="product_preview__nav-wrapper product_preview__nav-wrapper--next">
                                        ...
                                        <div class="product_preview__nav-content product_preview__nav-content--next">
                                            <?if($arResult['NEXT_ITEM']['PREVIEW_PICTURE'] || $arResult['NEXT_ITEM']['DETAIL_PICTURE']):?>
                                                ...
                                                <div class="product_preview__nav-img">
                                                    <img src="<?=CFile::GetPath(($arResult['NEXT_ITEM']['PREVIEW_PICTURE']) ? $arResult['NEXT_ITEM']['PREVIEW_PICTURE'] : $arResult['PREV_ITEM']['DETAIL_PICTURE']);?>" alt="">
                                                </div>

                                            <?endif;?>
                                            <div class="product_preview__nav-description">
                                                <p class="product_preview__nav-title-slide"><?=Loc::getMessage('DETAIL_NEXT_ITEM');?></p>
                                                <p class="product_preview__nav-item-name"><?=$arResult['NEXT_ITEM']['NAME']?></p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                    ...
                    <script>
                        function clipText () {
                            ...
                            let itemName = document.getElementsByClassName('product_preview__nav-item-name');
                            if (itemName.length > 0) {
                                for (let i = 0; itemName.length > i; i++) {
                                    let text = null;
                                    if (itemName[i].innerText.length >= 17) {
                                        text = itemName[i].innerText.slice(0, 17) + '...';
                                    } else {
