...
<?if($arResult["DELIVERY"]):?>
    ...
    <div class="product_detail_info__delivery-more">
        ...
        <a class="product_detail_info__delivery-link product_detail_info__delivery-link--btn" href="#TAB_DELIVERY"><?=Loc::getMessage('kit.regions_SHOW_DELIVERY_TAB')?>
        ...
        <a class="product_detail_info__delivery-link" title="<?=Loc::getMessage('kit.regions_DETAIL_DELIVERY_PAGE')?>" target="_blank" href="<?=SITE_DIR?>help/delivery/"><?=Loc::getMessage('kit.regions_DETAIL_DELIVERY_PAGE')?></a>
        <?endif;?>
    </div>
<?endif;?>
<script>
