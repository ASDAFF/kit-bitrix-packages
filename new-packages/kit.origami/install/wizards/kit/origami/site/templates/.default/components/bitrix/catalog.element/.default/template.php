                                ...
                                <div class="product-item-detail-slider-controls-block swiper-container gallery-thumbs" id="<?= $itemIds['SLIDER_CONT_ID'] ?>">
                                    ...
                                    if (!empty($actualItem['MORE_PHOTO']))
                                    {
                                        foreach ($actualItem['MORE_PHOTO'] as $key => $photo)
                                        {
                                            $photoSmall = ($photo['SMALL']) ? $photo['SMALL'] : $photo['ORIGINAL'];
                                            ?>
                                            <div class="product-item-detail-slider-controls-image swiper-slide<?= ($key == 0 ? ' active' : '') ?>"
                                                 data-entity="slider-control"
            ...
            <div class="detailed-tabs">
                <div class="swiper-container">
                    <ul class="detailed-tabs__tabs swiper-wrapper">
                        ...
                        {
                            ?>
                            <li class="detailed-tabs__tabs-item swiper-slide <?= ($i == 0) ? 'active' : '' ?>"
                                id="TAB_<?= $tab['TYPE'] ?>">
                                <p><?= $tab['NAME'] ?></p>
                            </li>
                            <?
                    ...
                    foreach ($arResult['TABS'] as $i => $tab)
                    {
                        switch ($tab['TYPE'])
                        {
                            case 'DESCRIPTION':
                                ...
                                {
                                    ?>
                                    <div class="detailed-tabs__content detailed-tabs__description <?= ($i == 0) ? 'active' : '' ?>">
                                        <?
                            ...
                            case 'PROPERTIES':
                                ?>
                                <div class="detailed-tabs__content detailed-tabs__options <?= ($i == 0) ? 'active' : '' ?>">
                                    <?
                            ...
                            case 'DELIVERY':
                                ?>
                                <div class="detailed-tabs__content detailed-tabs__delivery <?= ($i == 0) ? 'active' : '' ?>" id="DELIVERY_CONTENT">
                                <?
                                $startAjax = 'N';
                                if($i == 0)
                                    $startAjax = 'Y';
...
<!--                                    </script>-->
                            ...
                            case 'COMMENTS':
                                ?>
                                <div class="detailed-tabs__content detailed-tabs__reviews <?= ($i == 0) ? 'active' : '' ?>">
                                    <?
                            ...
                            case 'VIDEO':
                                ?>
                                <div class="detailed-tabs__content detailed-tabs__video <?= ($i == 0) ? 'active' : '' ?>">
                                    <?
                            ...
                            case 'DOCS':
                                ?>
                                <div class="detailed-tabs__content detailed-tabs__documents <?= ($i == 0) ? 'active' : '' ?>">
                                    <?
                                    if ($arResult['DOCS'])
                                    {
                                        ?>
