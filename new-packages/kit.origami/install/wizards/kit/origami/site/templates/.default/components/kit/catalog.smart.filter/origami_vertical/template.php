...
if($mobileFilter) {
    $this->addExternalJs($templateFolder . "/mobile_new_header.js");
    $this->addExternalCss($templateFolder . "/mobile_new_header.css");
} else {
...
<div class="bx-sidebar-block bx_filter_wrapper">
    <div class="bx_filter">
        <div class="bx_filter_section">
            <div class="block_main_left_menu__title fonts__main_text active" onclick="collapseFilter()">
                <div>
            ...
            <form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="<? echo $arResult["FORM_ACTION"] ?>"
                ...
                <div class="bx_filter_popup_result 1 fonts__middle_comment <?=Config::get('MENU_SIDE') == 'left' ? 'right' : 'left'?>" id="modef" <?=(!isset($arResult["ELEMENT_COUNT"]))?'style="display:none"':'style="display: inline-block;"'?> >
