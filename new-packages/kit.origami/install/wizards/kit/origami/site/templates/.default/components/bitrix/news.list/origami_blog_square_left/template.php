...
<div id="blog__wrapper_<?=$idItem?>" class="blog__wrapper puzzle_block main-container size">
        <p class="puzzle_block__title fonts__middle_title">
            <?=$arParams["BLOCK_NAME"]?>
            <a href="<?=($arResult["ITEMS"][0]["LIST_PAGE_URL"]) ? $arResult["ITEMS"][0]["LIST_PAGE_URL"] : $arParams["LINK_TO_THE_FULL_LIST"]?>" class="puzzle_block__link fonts__small_text" title="<?=Loc::getMessage("SOTBIT_BLOG_SQUARE_LEFT_LINK_TEXT");?>">
                <?=Loc::getMessage("SOTBIT_BLOG_SQUARE_LEFT_LINK_TEXT");?>
                <i class="icon-nav_1"></i>
            </a>
        </p>

        <div class="blog_block-square blog_block-square--left swiper-container">
...
<script>
    ...
    const origamiBlogSquare_left__<?=$idItem?> = new CreateSlider ({
