...
?>
<div class="product_card__inner product_card__inner--three <?=( $arParams['MOBILE_VIEW_MINIMAL'] == 'Y' ? "product_card__inner--three-min" : "" )?>">
                    ...
                    if ($code == Config::get('COLOR'))
                    {
                        ...
                        <div class="product-card-inner__option-color">
                            ...
                            <div class="product-card-inner__option-list" data-entity="sku-line-block">
                                ...
                                foreach ($skuProperty['VALUES'] as $value) {
                                    ...
                                    ?>
                                    <label for="<?=$item['ID']?>_<?=$propertyId ?>_<?=$value['ID'] ?>" class="product-card-inner__option-item"
                        ...
                        <div class="product-card-inner__option-memory" data-entity="sku-block">
                            ...
                            foreach ($skuProperty['VALUES'] as $value)
                            {
                                ...
                                ?>
                                <label
                                        for="<?=$item['ID']?>_<?= $propertyId ?>_<?= $value['ID'] ?>"
                                ...
                                >
                                    <span class="product-card-inner__option-item-content">
                                        ...
                                        <input type="radio" name="memory" id="<?=$item['ID']?>_<?= $propertyId ?>_<?= $value['ID'] ?>">
                                    </span>
                                </label>
                ...
                <div class="product-card-inner__buy">
                    ...
                    if($arParams['USE_PRODUCT_QUANTITY'])
                    {
                        ...
                        <div class="product-card-inner__counter product-counter__amount" data-entity="quantity-block">
                            ...
                            <input type="text" name="" id="<?=$itemIds['QUANTITY']?>" value="<?=$measureRatio?>">
