	...
	<div class="select-city__dropdown-wrap" style="<?=($arResult['SHOW_POPUP'] == 'Y')?'display:block;':'display:none;'?>">
		<div class="select-city__dropdown">
			...
			<div class="select-city__dropdown__choose-wrap">
				<span class="select-city__dropdown__choose__yes select-city__dropdown__choose" data-id="<?=$arResult['USER_REGION_ID']?>"><?=Loc::getMessage(SotbitRegions::moduleId.'_YES')?></span>
		...
		<div class="select-city__modal__submit-wrap">
			...
			<div class="select-city__modal__submit__block-wrap">
				<div class="select-city__modal__submit__block-wrap__input_wrap">
					<div class="select-city__modal__submit__block-wrap__input_wrap_error" style="display:none;"><?=Loc::getMessage(SotbitRegions::moduleId.'_ERROR')?></div>
					<input value="" type="text" class="select-city__modal__submit__input">
				</div>
				<input type="submit" name="submit" value="<?=Loc::getMessage(SotbitRegions::moduleId.'_SELECT_SUBMIT')?>" class="select-city__modal__submit__btn">
			</div>
		</div>
    </div>
</div>
