	...
	BX.Sale.OrderAjaxComponent = {
		...
		editAuthorizeForm: function(authContent)
		{
			...
			login = this.createAuthFormInputContainer(
                ...
                BX.create('DIV', {
                    props: {
                        className: 'main-input-md__wrapper'
                    },
                    children: [
                        BX.create('INPUT', {
                            attrs: {
                            ...
                            props: {
                                ...
                                maxlength: "30",
                                className: 'main-input-md main-input-bg--gray' + ' ' + this.isAuthFormInputFilled.call(this, 'USER_LOGIN'),
                                id: 'checkout-STOF_LOGIN'
                            },
                            events: {keypress: BX.proxy(this.checkKeyPress, this)}
                        }),
                        BX.create('LABEL', {
                            attrs: {
                                'for': 'checkout-STOF_LOGIN',
                            },
                            props: {
                                className: 'main-label-md',
                            },
                            html: BX.message('STOF_LOGIN') + ' *'
                        }),
                    ]
                }),
                true
                    ...
                    children: [
                        BX.create('INPUT', {
                            ...
                            props: {
                                ...
                                value: '',
                                maxlength: "30",
                                className: 'main-input-md main-input-bg--gray',
                                id: 'checkout-STOF_PASSWORD'
                            },
                            events: {keypress: BX.proxy(this.checkKeyPress, this)}
                        }),
                        BX.create('LABEL', {
                            attrs: {
                                'for': 'checkout-STOF_PASSWORD',
                            },
                            props: {
                                className: 'main-label-md',
                            },
                            html: BX.message('STOF_PASSWORD') + ' *'
                        }),
                    ]
                }),
                true
			...
			authContent.appendChild(BX.create('DIV', {props: {className: 'col-md-6 auth-form-node'}, children: [authFormNode]}));
		},

        isAuthFormInputFilled: function (key) {
            return this.result.AUTH[key]
                ? 'filled'
                : '';
        },
		...
		editRegistrationForm: function(authContent)
		{
                    ...
                    children: [
                        BX.create('INPUT', {
                            ...
                            props: {
                                ...
                                className: 'main-input-md main-input-bg--gray' + ' ' + this.isAuthFormInputFilled.call(this, 'NEW_NAME'),
                                id: 'checkout-STOF_NAME'
                            },
                            events: {keypress: BX.proxy(this.checkKeyPress, this)}
                        }),
                        BX.create('LABEL', {
                            attrs: {
                                'for': 'checkout-STOF_NAME',
                            },
                            props: {
                                className: 'main-label-md',
                            },
                            html: BX.message('STOF_NAME') + ' *'
                        }),
                    ]
                }),
				true
                    ...
                    children: [
                        BX.create('INPUT', {
                            ...
                            props: {
                                ...
                                className: 'main-input-md main-input-bg--gray' + ' ' + this.isAuthFormInputFilled.call(this, 'NEW_LAST_NAME'),
                                id: 'checkout-STOF_LASTNAME'
                            },
                            events: {keypress: BX.proxy(this.checkKeyPress, this)}
                        }),
                        BX.create('LABEL', {
                            attrs: {
                                'for': 'checkout-STOF_LASTNAME',
                            },
                            props: {
                                className: 'main-label-md',
                            },
                            html: BX.message('STOF_LASTNAME') + ' *'
                        }),
                    ]
                }),
				true
                    ...
                    children: [
                        BX.create('INPUT', {
                            attrs: {
                                ...
                                'onchange': 'isInputFilled(this)',
                                'required': setRequiredArrt.call(this)
                            },
                            props: {
                                name: 'NEW_EMAIL',
                                type: 'text',
                                ...
                                className: 'main-input-md main-input-bg--gray' + ' ' + this.isAuthFormInputFilled.call(this, 'NEW_EMAIL'),
                                id: 'checkout-STOF_EMAIL'
                            },
                            events: {keypress: BX.proxy(this.checkKeyPress, this)},
                        }),
                        BX.create('LABEL', {
                            attrs: {
                                'for': 'checkout-STOF_EMAIL',
                            },
                            props: {
                                className: 'main-label-md',
                            },
                            html: BX.message('STOF_EMAIL') + isEmailRequired.call(this)
                        }),
                    ]
				}),
            ...
            function setRequiredArrt() {
                return this.result.AUTH.new_user_email_required === 'Y'
                    ? 'true'
                    : ''
            }
                        ...
                        children: [
                            ...
                            BX.create('LABEL', {
                                ...
                                children: [
                                    ...
                                    BX.create('SPAN', {
                                        html: BX.message('STOF_MY_PASSWORD')
                                    })
                                ],
                                events: {
                            ...
                            BX.create('LABEL', {
                                ...
                                children: [
                                    ...
                                    BX.create('SPAN', {
                                        html: BX.message('STOF_SYS_PASSWORD')
                                    })
                                ],
                                events: {
                                    change: BX.delegate(function () {
						...
						this.createAuthFormInputContainer(
                            ...
                            BX.create('DIV', {
                                ...
                                children: [
                                    ...
                                    BX.create('LABEL', {
                                        attrs: {
                                            'for': 'checkout-STOF_RE_PASSWORD',
                                        },
                                        props: {
                                            className: 'main-label-md',
                                        },
                                        html: BX.message('STOF_RE_PASSWORD') + ' *'
                                    }),
                                ]
                            }),
							true
                            ...
                            children: [
                                BX.create('INPUT', {
                                    ...
                                    props: {
                                        ...
                                        value: '',
                                        className: 'main-input-md main-input-bg--gray',
                                        id: 'checkout-CAPTCHA_REGF_PROMT'
                                    },
                                    events: {keypress: BX.proxy(this.checkKeyPress, this)}
                                }),
                                BX.create('LABEL', {
                                    attrs: {
                                        'for': 'checkout-CAPTCHA_REGF_PROMT',
                                    },
                                    props: {
                                        className: 'main-label-md',
                                    },
                                    html: 	BX.message('CAPTCHA_REGF_PROMT') + ' *'
                                }),
                            ]
                        }),
					]
			...
			authFormNodes.push(
				BX.create('DIV', {
					props: {className: 'bx-authform-formgroup-container buttons'},
					children: [
						BX.create('INPUT', {
							props: {
								id: 'do_register',
						...
						BX.create('DIV', {
							props: {className: 'main_btn-white', href: ''},
		...
		editSocialContent: function(authContent)
		{
			...
			authContent.appendChild(BX.create('DIV', {props: {className: 'col-md-6 auth-reg-redirect'}, children: nodes}));
		},
		...
		getAuthReference: function(authContent)
		{
			authContent.appendChild(
				BX.create('DIV', {
					props: {className: 'row description-wrapper'},
					children: [
						BX.create('DIV', {
		...
		createBasketItemImg: function(data)
		{
			...
			{
				//logotype = logotype && logotype.src_2x || this.defaultBasketItemLogo;
				logoNode.setAttribute('style', 'background-image: url('+logotype.src_2x+');');
			}
			else if(logotype && logotype.src_1x)
			{
				//logotype = logotype && logotype.src_1x || this.defaultBasketItemLogo;
				logoNode.setAttribute('style', 'background-image: url('+logotype.src_1x+');');
			}
			else
			{
				logoNode.setAttribute('style',
					'background-image: url('+this.defaultBasketItemLogo+');' +
					'background-image: -webkit-image-set(url('+this.defaultBasketItemLogo+') 1x, url('+this.defaultBasketItemLogo+') 2x)'
				);
			}
		...
		editPaySystemItems: function(paySystemNode)
		{
			...
			var paySystemItemsContainer = BX.create('DIV', {props: {className: 'col-sm-7 bx-soa-pp-item-container row'}}),
				paySystemItemNode, i;
		...
		editDeliveryItems: function(deliveryNode)
		{
			...
			var deliveryItemsContainer = BX.create('DIV', {props: {className: 'col-sm-7 bx-soa-pp-item-container row'}}),
				deliveryItemNode, k;
...
window.addEventListener('DOMContentLoaded', function () {
    let fixedBlock = new FixedBlock('.stiky-wrapper', {});
    fixedBlock.init();
});
