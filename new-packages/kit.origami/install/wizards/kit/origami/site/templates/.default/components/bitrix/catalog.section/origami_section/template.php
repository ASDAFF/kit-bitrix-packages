...
<?
if($arResult['ITEMS']):
$sectID = "sect_".\Bitrix\Main\Security\Random::getString(5); ?>
<!--$sectID = "sect_".$this->randString();-->


<div class="recommended-products" id="<?=$sectID?>">
	<p class="recommended-poducts__title puzzle_block__title fonts__middle_title">
		<?=$arParams["SECTION_NAME"]?>
    </p>
	<?if($arParams["SHOW_SLIDER"]=="Y"):?>
	<div class="recommended-products__slider swiper-container" data-entity="<?=$containerName?>">
        <div class="swiper-wrapper">
    <?else:?>
        <?if($arParams["LINE_ELEMENT_COUNT"]>0 && $arParams["LINE_ELEMENT_COUNT"]<4):?>
        <div class="recommended-products__row recommended-products__row--3" data-entity="<?=$containerName?>">
        <?elseif($arParams["LINE_ELEMENT_COUNT"]>3 && $arParams["LINE_ELEMENT_COUNT"]<5):?>
        <div class="recommended-products__row recommended-products__row--4" data-entity="<?=$containerName?>">
        <?else:?>
        <div class="recommended-products__row recommended-products__row--5" data-entity="<?=$containerName?>">
        <?endif?>
    <?endif;?>
        ...
        ?>
            ...
            <div class="btn-slider-main <?=$sliderButtons?> btn-slider-main--next"></div>
            <div class="btn-slider-main <?=$sliderButtons?> btn-slider-main--one btn-slider-main--prev"></div>
            <?endif;?>
    </div>
...
<script>
    ...
    const recommended_products__slider_<?=$sectID?> = new CreateSlider ({
        sliderContainer: '#<?=$sectID?> .recommended-products__slider',
        sizeSliderInit: 'all'
    });
</script>
</div>
