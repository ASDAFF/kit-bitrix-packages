...
if(is_array($arResult['FIELDS']['UF_PHONE']['VALUE']) && count($arResult['FIELDS']['UF_PHONE']['VALUE']) > 1):
    ...
    <div class="container_menu_mobile__phone_block">
        <a href="tel:<?=\KitOrigami::showDigitalPhone($phone)?>." class="header_top_block__phone__number origami_icons_button">
...
<?elseif(is_array($arResult['FIELDS']['UF_PHONE']['VALUE'])):
    ...
    ?>
    <div class="container_menu_mobile__phone_block">
        <a href="tel:<?=\KitOrigami::showDigitalPhone($phone)?>" class="header_top_block__phone__number">
            <?=$phone?>
        </a>
    </div>
<?else:
