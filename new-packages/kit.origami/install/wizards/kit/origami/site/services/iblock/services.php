...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/blocks/services/content.php", array("SERVICES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/blocks/services_images/content.php", array("SERVICES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/blocks/services_one_wide/content.php", array("SERVICES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"]."/include/blocks/services/content.php", array("SERVICES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"]."/include/blocks/services_images/content.php", array("SERVICES_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"]."/include/blocks/services_one_wide/content.php", array("SERVICES_IBLOCK_ID" => $iblockID));
*/
