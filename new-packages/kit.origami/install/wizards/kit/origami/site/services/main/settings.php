...
/******************Add footer image*************************/
Option::set('HEADER','8',WIZARD_SITE_ID);
Option::set('HEADER_BG_COLOR','header-three--black',WIZARD_SITE_ID);
...
Option::set('TYPE_MASK_VIEW','FLAGS',WIZARD_SITE_ID);
Option::set('MASK','+7(999)999-99-99',WIZARD_SITE_ID);

/*LASTVERSION 1.10*/
Option::set('SLIDER_BUTTONS','square',WIZARD_SITE_ID);
Option::set('IE_STUB','Y',WIZARD_SITE_ID);
Option::set('BASKET_TYPE','origami_top_without_basket',WIZARD_SITE_ID);
Option::set('SECTION_ROOT_TEMPLATE_SERVICES','sections_1',WIZARD_SITE_ID);
Option::set('SOP_DISPLAYED_FIELDS','a:2:{i:0;s:5:"EMAIL";i:1;s:5:"PHONE";}',WIZARD_SITE_ID);
Option::set('SOP_REQUIRED_FIELDS','a:2:{i:0;s:5:"EMAIL";i:1;s:5:"PHONE";}',WIZARD_SITE_ID);
