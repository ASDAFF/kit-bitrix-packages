...
$arVisual = [
    'TITLE' => [
        'SHOW' => ArrayHelper::getValue($arParams, 'WEB_FORM_TITLE_SHOW') == 'Y' && !empty($arResult['FORM_TITLE']),
        'POSITION' => ArrayHelper::fromRange($arPosition, ArrayHelper::getValue($arParams, 'WEB_FORM_TITLE_POSITION'))
    ],
    'DESCRIPTION' => [
        'SHOW' => ArrayHelper::getValue($arParams, 'WEB_FORM_DESCRIPTION_SHOW') == 'Y' && !empty($arResult['FORM_DESCRIPTION']),
        'POSITION' => ArrayHelper::fromRange($arPosition, ArrayHelper::getValue($arParams, 'WEB_FORM_DESCRIPTION_POSITION'))
    ],
