            ...
            <div class="system-auth-authorize-form intec-ui-form">
                <form method="POST" action="<?= $arResult['URL']['AUTHORIZE'] ?>">
                    ...
                    <div class="system-auth-authorize-form-fields intec-ui-form-fields">
                        <div class="system-auth-authorize-form-field intec-ui-form-field">
                            <div class="intec-ui-form-field-title">
                                <?= Loc::getMessage('C_SYSTEM_AUTH_AUTHORIZE_POPUP_1_FIELDS_LOGIN') ?>
                            </div>
                        ...
                        <div class="system-auth-authorize-form-field intec-ui-form-field">
                            <div class="intec-ui-form-field-title">
                                <?= Loc::getMessage('C_SYSTEM_AUTH_AUTHORIZE_POPUP_1_FIELDS_PASSWORD') ?>
                            </div>
                            <div class="intec-ui-form-field-content">
                        ...
                        <?php if (!empty($arResult['CAPTCHA_CODE'])) { ?>
                            <div class="system-auth-authorize-form-field intec-ui-form-field">
                                <div class="intec-ui-form-field-title">
                                    <?= Loc::getMessage('C_SYSTEM_AUTH_AUTHORIZE_POPUP_1_FIELDS_CAPTCHA') ?>
                                </div>
                                <div class="intec-ui-form-field-content">
                                    ...
                                    <div class="intec-grid-item-auto">
                                        <label class="system-auth-authorize-form-remember intec-ui intec-ui-control-checkbox intec-ui-scheme-current">
                                            ...
                                            <span class="intec-ui-part-content">
                                                <?= Loc::getMessage('C_SYSTEM_AUTH_AUTHORIZE_POPUP_1_REMEMBER') ?>
                                            </span>
                                        </label>
                                    </div>
                                <?php } ?>
                                ...
                                <?php if ($arParams['NOT_SHOW_LINKS'] !== 'Y' && !empty($arResult['URL']['RESTORE'])) { ?>
                                    <div class="intec-grid-item-auto">
                                        <a class="system-auth-authorize-form-restore" href="<?= $arResult['URL']['RESTORE'] ?>" rel="nofollow">
                                            <?= Loc::getMessage('C_SYSTEM_AUTH_AUTHORIZE_POPUP_1_RESTORE') ?>
                                        </a>
                                    </div>
                                <?php } ?>
                            </div>
                    ...
                    <div class="system-auth-authorize-form-buttons">
                        <?= Html::submitInput(Loc::getMessage('C_SYSTEM_AUTH_AUTHORIZE_POPUP_1_BUTTONS_AUTHORIZE'), [
                            'name' => 'Login',
                            'class' => [
                ...
                <?php if (!empty($arResult['AUTH_SERVICES'])) { ?>
                    <div class="system-auth-authorize-form-socials">
                        <div class="system-auth-authorize-form-socials-title">
                            <?= Loc::getMessage('C_SYSTEM_AUTH_AUTHORIZE_POPUP_1_SOCIALS') ?>
                        </div>
        ...
        <div class="intec-grid-item-2 intec-grid-item-800-1">
            <?php if (!empty($arResult['URL']['REGISTER']) && $arParams['NOT_SHOW_LINKS'] !== 'Y' && $arResult['NEW_USER_REGISTRATION'] === 'Y' && $arParams['AUTHORIZE_REGISTRATION'] !== 'Y') { ?>
                ...
                <div class="system-auth-authorize-registration">
                    <?= Html::a(Loc::getMessage('C_SYSTEM_AUTH_AUTHORIZE_POPUP_1_BUTTONS_REGISTER'), $arResult['URL']['REGISTER'], [
                        'class' => [
                    ...
                    <div class="system-auth-authorize-registration-text">
                        <?= Loc::getMessage('C_SYSTEM_AUTH_AUTHORIZE_POPUP_1_REGISTER') ?>
                    </div>
                </div>
            <?php } ?>
        </div>
