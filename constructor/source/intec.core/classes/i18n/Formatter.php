...
use intec\core\helpers\FormatConverter;
use intec\core\helpers\HtmlPurifier;
...
class Formatter extends Component
{
    ...
    public function init()
    {
        if ($this->timeZone === null) {
            $this->timeZone = Core::$app->timeZone;
        }
        if ($this->locale === null) {
            $this->locale = Core::$app->language;
        }
        if ($this->booleanFormat === null) {
            $this->booleanFormat = [Core::t('core', 'No', [], $this->locale), Core::t('core', 'Yes', [], $this->locale)];
        }
        if ($this->nullDisplay === null) {
            $this->nullDisplay = '<span class="not-set">' . Core::t('core', '(not set)', [], $this->locale) . '</span>';
        }
    ...
    public function asRelativeTime($value, $referenceTime = null)
    {
        ...
        if ($interval->invert) {
            if ($interval->y >= 1) {
                return Core::t('core', 'in {delta, plural, =1{a year} other{# years}}', ['delta' => $interval->y], $this->locale);
            }
            if ($interval->m >= 1) {
                return Core::t('core', 'in {delta, plural, =1{a month} other{# months}}', ['delta' => $interval->m], $this->locale);
            }
            if ($interval->d >= 1) {
                return Core::t('core', 'in {delta, plural, =1{a day} other{# days}}', ['delta' => $interval->d], $this->locale);
            }
            if ($interval->h >= 1) {
                return Core::t('core', 'in {delta, plural, =1{an hour} other{# hours}}', ['delta' => $interval->h], $this->locale);
            }
            if ($interval->i >= 1) {
                return Core::t('core', 'in {delta, plural, =1{a minute} other{# minutes}}', ['delta' => $interval->i], $this->locale);
            }
            if ($interval->s == 0) {
                return Core::t('core', 'just now', [], $this->locale);
            }
            return Core::t('core', 'in {delta, plural, =1{a second} other{# seconds}}', ['delta' => $interval->s], $this->locale);
        } else {
            if ($interval->y >= 1) {
                return Core::t('core', '{delta, plural, =1{a year} other{# years}} ago', ['delta' => $interval->y], $this->locale);
            }
            if ($interval->m >= 1) {
                return Core::t('core', '{delta, plural, =1{a month} other{# months}} ago', ['delta' => $interval->m], $this->locale);
            }
            if ($interval->d >= 1) {
                return Core::t('core', '{delta, plural, =1{a day} other{# days}} ago', ['delta' => $interval->d], $this->locale);
            }
            if ($interval->h >= 1) {
                return Core::t('core', '{delta, plural, =1{an hour} other{# hours}} ago', ['delta' => $interval->h], $this->locale);
            }
            if ($interval->i >= 1) {
                return Core::t('core', '{delta, plural, =1{a minute} other{# minutes}} ago', ['delta' => $interval->i], $this->locale);
            }
            if ($interval->s == 0) {
                return Core::t('core', 'just now', [], $this->locale);
            }
            return Core::t('core', '{delta, plural, =1{a second} other{# seconds}} ago', ['delta' => $interval->s], $this->locale);
        }
    }
    ...
    public function asDuration($value, $implodeString = ', ', $negativeSign = '-')
    {
        ...
        if ($interval->y > 0) {
            $parts[] = Core::t('core', '{delta, plural, =1{1 year} other{# years}}', ['delta' => $interval->y], $this->locale);
        }
        if ($interval->m > 0) {
            $parts[] = Core::t('core', '{delta, plural, =1{1 month} other{# months}}', ['delta' => $interval->m], $this->locale);
        }
        if ($interval->d > 0) {
            $parts[] = Core::t('core', '{delta, plural, =1{1 day} other{# days}}', ['delta' => $interval->d], $this->locale);
        }
        if ($interval->h > 0) {
            $parts[] = Core::t('core', '{delta, plural, =1{1 hour} other{# hours}}', ['delta' => $interval->h], $this->locale);
        }
        if ($interval->i > 0) {
            $parts[] = Core::t('core', '{delta, plural, =1{1 minute} other{# minutes}}', ['delta' => $interval->i], $this->locale);
        }
        if ($interval->s > 0) {
            $parts[] = Core::t('core', '{delta, plural, =1{1 second} other{# seconds}}', ['delta' => $interval->s], $this->locale);
        }
    ...
    public function asShortSize($value, $decimals = null, $options = [], $textOptions = [])
    {
        ...
        if ($this->sizeFormatBase == 1024) {
            switch ($position) {
                case 0:
                    return Core::t('core', '{nFormatted} B', $params, $this->locale);
                case 1:
                    return Core::t('core', '{nFormatted} KiB', $params, $this->locale);
                case 2:
                    return Core::t('core', '{nFormatted} MiB', $params, $this->locale);
                case 3:
                    return Core::t('core', '{nFormatted} GiB', $params, $this->locale);
                case 4:
                    return Core::t('core', '{nFormatted} TiB', $params, $this->locale);
                default:
                    return Core::t('core', '{nFormatted} PiB', $params, $this->locale);
            }
        } else {
            switch ($position) {
                case 0:
                    return Core::t('core', '{nFormatted} B', $params, $this->locale);
                case 1:
                    return Core::t('core', '{nFormatted} KB', $params, $this->locale);
                case 2:
                    return Core::t('core', '{nFormatted} MB', $params, $this->locale);
                case 3:
                    return Core::t('core', '{nFormatted} GB', $params, $this->locale);
                case 4:
                    return Core::t('core', '{nFormatted} TB', $params, $this->locale);
                default:
                    return Core::t('core', '{nFormatted} PB', $params, $this->locale);
            }
        }
    }
    ...
    public function asSize($value, $decimals = null, $options = [], $textOptions = [])
    {
        ...
        if ($this->sizeFormatBase == 1024) {
            switch ($position) {
                case 0:
                    return Core::t('core', '{nFormatted} {n, plural, =1{byte} other{bytes}}', $params, $this->locale);
                case 1:
                    return Core::t('core', '{nFormatted} {n, plural, =1{kibibyte} other{kibibytes}}', $params, $this->locale);
                case 2:
                    return Core::t('core', '{nFormatted} {n, plural, =1{mebibyte} other{mebibytes}}', $params, $this->locale);
                case 3:
                    return Core::t('core', '{nFormatted} {n, plural, =1{gibibyte} other{gibibytes}}', $params, $this->locale);
                case 4:
                    return Core::t('core', '{nFormatted} {n, plural, =1{tebibyte} other{tebibytes}}', $params, $this->locale);
                default:
                    return Core::t('core', '{nFormatted} {n, plural, =1{pebibyte} other{pebibytes}}', $params, $this->locale);
            }
        } else {
            switch ($position) {
                case 0:
                    return Core::t('core', '{nFormatted} {n, plural, =1{byte} other{bytes}}', $params, $this->locale);
                case 1:
                    return Core::t('core', '{nFormatted} {n, plural, =1{kilobyte} other{kilobytes}}', $params, $this->locale);
                case 2:
                    return Core::t('core', '{nFormatted} {n, plural, =1{megabyte} other{megabytes}}', $params, $this->locale);
                case 3:
                    return Core::t('core', '{nFormatted} {n, plural, =1{gigabyte} other{gigabytes}}', $params, $this->locale);
                case 4:
                    return Core::t('core', '{nFormatted} {n, plural, =1{terabyte} other{terabytes}}', $params, $this->locale);
                default:
                    return Core::t('core', '{nFormatted} {n, plural, =1{petabyte} other{petabytes}}', $params, $this->locale);
            }
        }
    }
