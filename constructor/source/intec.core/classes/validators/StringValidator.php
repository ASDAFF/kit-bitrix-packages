...
class StringValidator extends Validator
{
    ...
    public function init()
    {
        ...
        if ($this->encoding === null) {
            $this->encoding = Core::$app->charset;
        }
        if ($this->message === null) {
            $this->message = Core::t('core', '{attribute} must be a string.');
        }
        if ($this->min !== null && $this->tooShort === null) {
            $this->tooShort = Core::t('core', '{attribute} should contain at least {min, number} {min, plural, one{character} other{characters}}.');
        }
        if ($this->max !== null && $this->tooLong === null) {
            $this->tooLong = Core::t('core', '{attribute} should contain at most {max, number} {max, plural, one{character} other{characters}}.');
        }
        if ($this->length !== null && $this->notEqual === null) {
            $this->notEqual = Core::t('core', '{attribute} should contain {length, number} {length, plural, one{character} other{characters}}.');
        }
    }
