<?php
namespace intec\core\db\mysql;

use intec\core\db\Expression;
use intec\core\db\TableSchema;
use intec\core\db\ColumnSchema;
 ...
 * @since 2.0
 */
class Schema extends \intec\core\db\Schema
{
    /**
