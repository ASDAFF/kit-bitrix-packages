...
$db_collection_category = \Kit\Crosssell\Orm\CrosssellCategoryTable::getList(array(
    'select' =>
        array(
            'ID', 'NAME'
        ),
...
$collectionListTemplates = CComponentUtil::GetTemplatesList("kit:crosssell.collection.list", $_GET['template_id']);
