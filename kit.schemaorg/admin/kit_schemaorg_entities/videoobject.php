...
$langPrefix = 'KIT_SCHEMA_VIDEOOBJECT_';
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "musicBy",
    array(
        '' => '...',
        'person' => 'Person',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "thumbnail",
    array(
        '' => '...',
