...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "affiliation",
    array(
        '' => '...',
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "children",
    array(
        '' => '...',
        'person' => 'Person',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "colleague",
    array(
        '' => '...',
        'person' => 'Person',
    ),
...
$tabControl = KitSchema::makeMultipleDropDownField($tabControl, "follows",
    array(
        '' => '...',
        'person' => 'Person',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "homeLocation",
    array(
        '' => '...',
        'contactpoint' => 'ContactPoint',
        'place' => 'Place',
...
$tabControl = KitSchema::makeMultipleDropDownField($tabControl, "knows",
    array(
        '' => '...',
        'person' => 'Person',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "nationality",
    array(
        '' => '...',
        'country' => 'Country',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "parent",
    array(
        '' => '...',
        'person' => 'Person',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "performerIn",
    array(
        '' => '...',
        'event' => 'Event',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "relatedTo",
    array(
        '' => '...',
        'person' => 'Person',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "sibling",
    array(
        '' => '...',
        'person' => 'Person',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "spouse",
    array(
        '' => '...',
        'person' => 'Person',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "workLocation",
    array(
        '' => '...',
        'contactpoint' => 'ContactPoint',
        'place' => 'Place',
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "worksFor",
    array(
        '' => '...',
        'organization' => 'Organization',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "netWorth",
    array(
        '' => '...',
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "birthPlace",
    array(
        '' => '...',
        'place' => 'Place',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "deathPlace",
    array(
        '' => '...',
        'place' => 'Place',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "hasOfferCatalog",
    array(
        '' => '...',
...
$tabControl = KitSchema::makeMultipleDropDownField($tabControl, "colleagues",
    array(
        '' => '...',
        'person' => 'Person',
    ),
...
$tabControl = KitSchema::makeMultipleDropDownField($tabControl, "parents",
    array(
        '' => '...',
        'person' => 'Person',
    ),
...
$tabControl = KitSchema::makeMultipleDropDownField($tabControl, "siblings",
    array(
        '' => '...',
        'person' => 'Person',
    ),
