...
$langPrefix = 'KIT_SCHEMA_REVIEWS_';
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "itemReviewed",
    array(
        '' => '...',
        'thing' => 'Thing',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "reviewRating",
    array(
        '' => '...',
        'rating' => 'Rating',
    ),
