...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "breadcrumb",
    array(
        '' => '...',
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "primaryImageOfPage",
    array(
        '' => '...',
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "reviewedBy",
    array(
        '' => '...',
        'person' => 'Person',
