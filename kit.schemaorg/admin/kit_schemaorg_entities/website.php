...
$langPrefix = 'KIT_SCHEMA_WEBSITE_';
...
?>
    <tr class="adm-detail-file-row">
        <td colspan="2" style="text-align: center">
            <input type="hidden" name="<?=$key ? $key."[@type]" : "@type"?>" value="WebSite"/>
        </td>
    </tr>
<?
$tabControl->EndCustomField("type_BLOCK");
$tabControl->AddEditField($key ? $key."[issn]" : "issn", GetMessage($langPrefix.'issn'), false, false,
    ( isset($arFields["issn"]) & !empty($arFields["issn"]) ? $arFields["issn"] : "" ));
