...
$MESS["kit_new_order_phone_order_name"] = "Оформлен новый заказ по телефону № #ORDER_ID#";
$MESS["kit_new_order_phone_order_message"] = "Оформлен новый заказ по телефону № #ORDER_ID#\r\n\r\n Состав заказа:\r\n\r\n#PRODUCT_LIST# \r\n\r\n Номер телефона покупателя: #PHONE#\r\n\r\n Для просмотра заказа в интернет-магазине пройдите по ссылке http://#SERVER_NAME#/bitrix/admin/sale_order_detail.php?ID=#ORDER_ID#&lang=ru";
$MESS["SOP_SHT"] = "шт.";

$MESS["CATALOG_ERR_NO_PRODUCT"] = "Продукт в каталоге не найден";
$MESS["CATALOG_PRODUCT_PRICE_NOT_FOUND"] = "Цена не найдена";
$MESS["kit_error_demo"] = "<h3 style='color:red' >Срок дейставия <a target='_blank' href='http://marketplace.1c-bitrix.ru/solutions/kit.orderphone/'>демо-режима</a>  истек! Функционал модуля будет недоступен!</h3>";
?>