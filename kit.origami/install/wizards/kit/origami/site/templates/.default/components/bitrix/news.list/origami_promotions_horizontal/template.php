...
<div class="promotion-block__wrapper main-container">
    <p class="puzzle_block__title fonts__middle_title">
        <?=$arParams["BLOCK_NAME"]?>
        <a href="<?=($arResult["ITEMS"][0]["LIST_PAGE_URL"]) ? $arResult["ITEMS"][0]["LIST_PAGE_URL"] : $arParams["LINK_TO_THE_FULL_LIST"]?>" title="<?=Loc::getMessage("KIT_PROMOTIONS_HORIZONTAL_LINK_TEXT");?>" class="puzzle_block__link fonts__small_text">
            <?=Loc::getMessage("KIT_PROMOTIONS_HORIZONTAL_LINK_TEXT");?>
            <i class="icon-nav_1"></i>
        </a>
    </p>

    <div class="promotion_block_three">
        <?$i = 0;?>
        ...
        ?>
            ...
            ?>
            <?if($i == 1):?>
                <div class="promotion_block_three__content" data-timer="timerID_<?=$blockID?>">
            <?elseif($i == 2):?>
                <div class="promotion_block_three__content" data-timer="timerID_<?=$blockID?>">
            <?else:?>
                <div class="promotion_block_three__content" data-timer="timerID_<?=$blockID?>">
