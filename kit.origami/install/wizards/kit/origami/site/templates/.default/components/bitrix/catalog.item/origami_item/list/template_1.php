...
?>
<div class="product_card__inner product_card__inner--row">
    <div class="product_card__inner-wrapper">
                ...
                <div class="product-card-inner__info">
                    ...
                    if ($arParams['SHOW_MAX_QUANTITY'] !== 'N')
                    {
                        if ($haveOffers)
                        {
                            ...
                            {
                                ?>
                                <div id="<?=$itemIds['QUANTITY_LIMIT']?>" style="display: none;" data-entity="quantity-limit-block">
        ...
        <div class="product-card-inner__buy-wrapper">
            ...
            <form method="post" class="product-card-inner__form"  id="check_offer_basket_<?=$item['ID']?>">
                ...
                <div data-entity="buttons-block" class="product-card-inner__buttons-block <?=($haveOffers? " offer": "")?>">
                    ...
                    <?if ($haveOffers):?>
                        <div class="product-card-inner__buttom-more">
                            <a class="product-card-inner__buttom-more-btn" href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=Loc::getMessage('ITEM_MORE')?> <?=$item["NAME"]?>">
