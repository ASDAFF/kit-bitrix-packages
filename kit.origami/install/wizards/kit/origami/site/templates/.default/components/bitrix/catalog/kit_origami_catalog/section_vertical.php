...
<?endif;?>
    <div class="block_main_left_menu__container mo-main">
        ...
        $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "COMPONENT_TEMPLATE" => "origami_filter",
    ...
    <div class="block_main_left_menu__content active no-padding">
        ...
        $APPLICATION->IncludeComponent(
            ...
            [
                ...
                "SEO_DESCRIPTION" => $arParams["SEO_DESCRIPTION"],
                "SECTION_DESCRIPTION" => $arParams["SECTION_DESCRIPTION"],
                "SECTION_DESCRIPTION_TOP" => $arParams["SECTION_DESCRIPTION_TOP"],
                "SECTION_DESCRIPTION_BOTTOM" => $arParams["SECTION_DESCRIPTION_BOTTOM"],
                "FILTER_NAME" => $arParams["FILTER_NAME"],
        ...
        if ($moduleSeo && $arParams['TAGS_POSITION'] == 'TOP')
        {
            $APPLICATION->IncludeComponent(
	"kit:seo.meta.tags",
	"origami_default",
	...
	false
        ...
        <div class="panel_filter_sort">
            ...
            {
                $sort = array();
                $sort = $APPLICATION->IncludeFile(SITE_DIR . "include/kit_origami/sort.php", Array(), Array());
            }
            ?>
        </div>
...
// Mobile view card
            ...
            <?
            if ($moduleSeo && $arParams['TAGS_POSITION'] == 'BOTTOM')
            {
                $APPLICATION->IncludeComponent(
                    "kit:seo.meta.tags",
                    "column",
