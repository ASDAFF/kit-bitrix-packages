...
function GetSiteDropDownListEx($strTypeName, $strIBlockName, $arFilter = false, $onChangeType = '', $onChangeIBlock = '', $strAddType = '', $strAddIBlock = '')
{
    ...
    {
        $arTypes[$filterId] = array(0 => GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_SITE"));
...
if (($_SERVER['REQUEST_METHOD'] == "POST" || $CUR_FILE_POS > 0) && $STEP > 1 && check_bitrix_sessid())
{
    ...
    if ($STEP > 1)
    {
        ...
        if (isset($_FILES["DATA_FILE"]) && is_uploaded_file($_FILES["DATA_FILE"]["tmp_name"]))
        {
            ...
            {
                $strError.= GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_NOT_CSV")."<br>";
            }
            else
            {
        ...
        if (strlen($strError) <= 0)
        {
            ...
            if (strlen($DATA_FILE_NAME) <= 0)
                $strError.= GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_NO_DATA_FILE_SIMPLE")."<br>";

            if (!CIBlockRights::UserHasRightTo($IBLOCK_ID, $IBLOCK_ID, "element_edit_any_wf_status"))
                $strError.= GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_NO_IBLOCK")."<br>";
        }
        ...
        if (strlen($strError) <= 0)
        {
            ...
            if ($fields_type == "R")
            {
                ...
                if (strlen($delimiter_r_char) != 1)
                    $strError.= GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_NO_DELIMITER")."<br>";
            ...
            else
            {
                ...
                if (strlen($metki_f) <= 0)
                    $strError.= GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_NO_METKI")."<br>";
            ...
            if (strlen($strError) <= 0)
            {
                if ($first_names_r == 'Y') {
                    ...
                    {
                        $strError.= GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_NO_DATA")."<br>";
                    }
    ...
    if ($STEP > 3)
    {
        ...
        if (!$bFieldsPres)
            $strError.= GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_NO_FIELDS")."<br>";
...
//                                            }
        ...
        if (strlen($strError) > 0)
        {
            $strError.= GetMessage(KitRegions::moduleId . "IBLOCK_ADM_IMP_TOTAL_ERRS")." ".$error_lines.".<br>";
            $strError.= GetMessage(KitRegions::moduleId . "IBLOCK_ADM_IMP_TOTAL_COR1")." ".$correct_lines." ".GetMessage(KitRegions::moduleId . "IBLOCK_ADM_IMP_TOTAL_COR2")."<br>";
            $STEP = 3;
        }
        //*****************************************************************//
...
/////////////////////////////////////////////////////////////////////
$APPLICATION->SetTitle(GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_PAGE_TITLE").$STEP);
...
if (!$bAllLinesLoaded)
{
    ...
    <?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_AUTO_REFRESH"); ?>
    <a href="<?echo $APPLICATION->GetCurPage(); ?>?lang=<?echo LANGUAGE_ID; ?>&<?echo $strParams ?>"><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_AUTO_REFRESH_STEP"); ?></a><br>
...
?>
    ...
    <form method="POST" action="<?=$APPLICATION->GetCurPage();?>?lang=<?=LANGUAGE_ID; ?>" ENCTYPE="multipart/form-data" name="dataload" id="dataload">
        <?$aTabs = array(
            array(
                "DIV" => "edit1",
                "TAB" => GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_TAB1") ,
                "ICON" => "iblock",
                "TITLE" => GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_TAB1_ALT"),
            ) ,
            array(
                "DIV" => "edit2",
                "TAB" => GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_TAB2") ,
                "ICON" => "iblock",
                "TITLE" => GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_TAB2_ALT"),
            ) ,
            array(
                "DIV" => "edit3",
                "TAB" => GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_TAB3") ,
                "ICON" => "iblock",
                "TITLE" => GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_TAB3_ALT"),
            ) ,
            array(
                "DIV" => "edit4",
                "TAB" => GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_TAB4") ,
                "ICON" => "iblock",
                "TITLE" => GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_TAB4_ALT"),
            ) ,
        );
        ...
        if ($STEP == 1)
        {
            ?>
            <tr>
                <td width="40%"><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_DATA_FILE"); ?></td>
                <td width="60%">
                    <input type="text" name="URL_DATA_FILE" value="<?echo htmlspecialcharsbx($URL_DATA_FILE); ?>" size="30">
                    <input type="button" value="<?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_OPEN"); ?>" OnClick="BtnClick()">
            ...
            <tr>
                <td><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_INFOBLOCK"); ?></td>
                <td>
        ...
        if ($STEP == 2)
        {
            ...
            <tr id="table_r" class="heading">
                <td colspan="2"><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_RAZDEL1"); ?></td>
            </tr>
            <tr id="table_r1">
                <td class="adm-detail-valign-top" style="width: 50%;"><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_RAZDEL_TYPE"); ?> :</td>
                <td>
                    <input type="radio" name="delimiter_r" id="delimiter_r_TZP" value="TZP" <?
                    if ($delimiter_r == "TZP" || strlen($delimiter_r) <= 0)
                        echo "checked" ?>><label for="delimiter_r_TZP"><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_TZP"); ?></label><br>
                    <input type="radio" name="delimiter_r" id="delimiter_r_ZPT" value="ZPT" <?
                    if ($delimiter_r == "ZPT")
                        echo "checked" ?>><label for="delimiter_r_ZPT"><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_ZPT"); ?></label><br>
                    <input type="radio" name="delimiter_r" id="delimiter_r_TAB" value="TAB" <?
                    if ($delimiter_r == "TAB")
                        echo "checked" ?>><label for="delimiter_r_TAB"><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_TAB"); ?></label><br>
                    <input type="radio" name="delimiter_r" id="delimiter_r_SPS" value="SPS" <?
                    if ($delimiter_r == "SPS")
                        echo "checked" ?>><label for="delimiter_r_SPS"><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_SPS"); ?></label><br>
                    <input type="radio" name="delimiter_r" id="delimiter_r_OTR" value="OTR" <?
                    if ($delimiter_r == "OTR")
                        echo "checked" ?>><label for="delimiter_r_OTR"><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_OTR"); ?></label>
                    <input type="text" name="delimiter_other_r" size="3" value="<?echo htmlspecialcharsbx($delimiter_other_r); ?>">
                </td>
            </tr>
            <tr id="table_r2">
                <td><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_FIRST_NAMES"); ?>:</td>
                <td>
            ...
            <tr class="heading">
                <td colspan="2">
                    <?echo GetMessage(KitRegions::moduleId .  "_EXPORT_ADM_EXP_IMP_DELIMITER") ?>
                    <input type="hidden" name="fields_type" value="R">
                </td>
            </tr>
            <tr>
                <td width="40%" class="adm-detail-valign-top"><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_EXP_IMP_DELIMITER") ?>:</td>
                <td width="60%">
                    <input type="radio" name="delimiter_r_f" id="delimiter_TZP" value="TZP" <?if ($delimiter_r_f=="TZP" || strlen($delimiter_r_f)<=0) echo "checked"?>><label for="delimiter_TZP"><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_EXP_IMP_DELIM_TZP") ?></label><br>
                    <input type="radio" name="delimiter_r_f" id="delimiter_ZPT" value="ZPT" <?if ($delimiter_r_f=="ZPT") echo "checked"?>><label for="delimiter_ZPT"><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_EXP_IMP_DELIM_ZPT") ?></label><br>
                    <input type="radio" name="delimiter_r_f" id="delimiter_TAB" value="TAB" <?if ($delimiter_r_f=="TAB") echo "checked"?>><label for="delimiter_TAB"><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_EXP_IMP_DELIM_TAB") ?></label><br>
                    <input type="radio" name="delimiter_r_f" id="delimiter_SPS" value="SPS" <?if ($delimiter_r_f=="SPS") echo "checked"?>><label for="delimiter_SPS"><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_EXP_IMP_DELIM_SPS") ?></label><br>
                    <input type="radio" name="delimiter_r_f" id="delimiter_OTR" value="OTR" <?if ($delimiter_r_f=="OTR") echo "checked"?>><label for="delimiter_OTR"><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_EXP_IMP_DELIM_OTR") ?></label>
                    <input type="text" name="delimiter_r_f_char" size="3" value="<?echo htmlspecialcharsbx($delimiter_r_f) ?>">
                </td>
            </tr>

            <tr class="heading">
                <td colspan="2"><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_DATA_SAMPLES"); ?></td>
            </tr>
            <tr>
        ...
        if ($STEP == 3)
        {
            ...
            <tr class="heading">
                <td colspan="2"><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_FIELDS_SOOT"); ?></td>
            </tr>
            ...
            foreach ($arDataFileFields as $i => $field)
            {
                ...
                <tr>
                    <td width="40%">
                        <b><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_FIELD"); ?> <?echo $i + 1 ?></b> (<?echo htmlspecialcharsbx($field); ?>):
                    </td>
                    <td width=60"%">
            ...
            <tr class="heading">
                <td colspan="2"><?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_ADDIT_SETTINGS"); ?></td>
            </tr>
            <tr>
                <td width="40%">
                    <b><?echo GetMessage(KitRegions::moduleId . "_EXPORT_UPDATE_REGIONS"); ?></b>:
                </td>
                <td width="60%">
                    ...
                    <br>
                    <label for="field_update"><small><?echo GetMessage(KitRegions::moduleId . "_EXPORT_UPDATE_REGIONS_ABOUT"); ?></small></label>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <? CAdminMessage::ShowMessage(array(
                        "TYPE" => "PROGRESS",
                        "MESSAGE" => !$bAllLinesLoaded? GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_AUTO_REFRESH_CONTINUE"): GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_SUCCESS"),
                        "DETAILS" =>
                            GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_SU_ALL").' <b>'. (string)($line_num + $correct_lines) .'</b><br>'
                            .GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_SU_CORR").' <b>'.$line_num.'</b><br>'
                            .GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_SU_ER").' <b>'.$correct_lines.'</b><br>'
                    ,
                        "HTML" => true,
                    ))?>
                </td>
        ...
        <?
        if ($STEP > 1): ?>
        <input type="submit" name="backButton" value="&lt;&lt; <?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_BACK"); ?>">
        <?
        endif
        ?>
        <input type="submit" <?echo ($STEP == 3) ? "disabled" : "" ?> value="<?echo ($STEP == 3) ? GetMessage
        (KitRegions::moduleId
            . "_EXPORT_ADM_IMP_NEXT_STEP_F") : GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_NEXT_STEP"); ?> &gt;&gt;" name="submit_btn" class="adm-btn-save">
        ...
        <input type="submit" name="backButton2" value="&lt;&lt; <?echo GetMessage(KitRegions::moduleId . "_EXPORT_ADM_IMP_2_1_STEP"); ?>" class="adm-btn-save">
        <?
        endif;
