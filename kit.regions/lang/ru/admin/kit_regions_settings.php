...
$MESS[$moduleId.'_WIDGET_FIND_USER_METHOD_NOTE']='IpGeoBase - с помощью сервиса <a href="http://ipgeobase.ru" target="__blank">http://ipgeobase.ru</a><br>
GeoIp - с помощью PHP библиотеки <a href="http://php.net/manual/ru/book.geoip.php" target="__blank">geoip</a>. 
Библиотека настраивается на стороне сервера. Для ее настройки обратитесь к своему системному администратору.<br>
Модуль веб аналитики - с помощью модуля  <a href="/bitrix/admin/settings.php?lang=ru&mid=statistic&mid_menu=1" target="__blank">веб аналитики</a>
';
$MESS[$moduleId.'_WIDGET_ADD_ORDER_PROPERTY']='Добавлять регион в заказ';
$MESS[$moduleId.'_ADD_ORDER_PROPERTY_NOTE']='При включенной опции при оформление заказа будет создаваться свойство с регионом пользователя';
...
$MESS[$moduleId.'_WIDGET_MAPS_MARKER_NOTE']='Используется при отсуствии изображения маркера в регионе.<br>При пустом значении используется стандартные маркеры сервиса карт.';

$MESS[$moduleId.'_WIDGET_MAPS_YANDEX_API']='Яндекс.Карты API ключ';
$MESS[$moduleId.'_WIDGET_MAPS_GOOGLE_API']='Google Карты API ключ';
$MESS[$moduleId.'_WIDGET_MAPS_GOOGLE_API_NOTE']='Используется при отсуствии ключа в регионе<br>
