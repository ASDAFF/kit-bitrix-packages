...
$MESS[$moduleId.'_TITLE'] = 'Регионы';
$MESS[$moduleId.'_ADD'] = 'Добавить';
$MESS[$moduleId.'_EDIT'] = 'Изменить';
$MESS[$moduleId.'_DELETE'] = 'Удалить';
$MESS[$moduleId.'_DELETE_CONFIRM'] = 'Вы действительно хотите удалить регион?';
$MESS[$moduleId.'_PAGES'] = 'Страницы';
$MESS[$moduleId.'_CODE'] = 'Поддомен';
$MESS[$moduleId.'_NAME'] = 'Регионы';
$MESS[$moduleId.'_SITE'] = 'Сайт';
$MESS[$moduleId.'_SITE_ANY'] = 'Любой';
$MESS[$moduleId.'_SORT'] = 'Сортировка';
$MESS[$moduleId.'_PRICE_CODE'] = 'Типы цен';
$MESS[$moduleId.'_STORE'] = 'Склады';
