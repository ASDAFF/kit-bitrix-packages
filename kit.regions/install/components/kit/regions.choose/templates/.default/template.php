...
if($allRegions === false && $USER->isAdmin()){
    echo Loc::getMessage(KitRegions::moduleId . '_REGION_TABLE_IS_EMPTY');
            ...
            <div class="select-city__dropdown">
                ...
                <div class="select-city__dropdown__choose-wrap">
                    <span class="select-city__dropdown__choose__yes select-city__dropdown__choose"
                          data-id="<?= $arResult['USER_REGION_ID'] ?>"><?= Loc::getMessage(KitRegions::moduleId . '_YES') ?></span>
                ...
                <div class="select-city__modal__submit__block-wrap">
                    <div class="select-city__modal__submit__block-wrap__input_wrap">
                        <div class="select-city__modal__submit__block-wrap__input_wrap_error"
                             style="display:none;"><?= Loc::getMessage(KitRegions::moduleId . '_ERROR') ?></div>
