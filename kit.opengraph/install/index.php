...
Class kit_opengraph extends CModule
{
    const MODULE_ID = 'kit.opengraph';
    var $MODULE_ID = 'kit.opengraph';
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = Loc::getMessage('KIT_OPENGRAPH_MODULE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('KIT_OPENGRAPH_MODULE_DESC');
        $this->PARTNER_NAME = Loc::getMessage('KIT_OPENGRAPH_PARTNER_NAME');
        $this->PARTNER_URI = Loc::getMessage('KIT_OPENGRAPH_PARTNER_URI');
    }
    ...
    {
        EventManager::getInstance()->registerEventHandler('main', 'OnBeforeProlog', self::MODULE_ID, '\Kit\Opengraph\EventHandlers', 'OnBeforeProlog');
        EventManager::getInstance()->registerEventHandler('main', 'OnBeforeEndBufferContent', self::MODULE_ID, '\Kit\Opengraph\EventHandlers', 'OnBeforeEndBufferContent');
        EventManager::getInstance()->registerEventHandler('main', 'OnPanelCreate', self::MODULE_ID, '\Kit\Opengraph\EventHandlers', 'onPanelCreate');
        return true;
    }
    ...
    {
        EventManager::getInstance()->unregisterEventHandler('main', 'OnBeforeProlog', self::MODULE_ID, '\Kit\Opengraph\EventHandlers', 'OnBeforeProlog');
        EventManager::getInstance()->unregisterEventHandler('main', 'OnBeforeEndBufferContent', self::MODULE_ID, '\Kit\Opengraph\EventHandlers', 'OnBeforeEndBufferContent');
        EventManager::getInstance()->unregisterEventHandler('main', 'OnPanelCreate', self::MODULE_ID, '\Kit\Opengraph\EventHandlers', 'onPanelCreate');
    }
