...
if ($IBLOCK_OFFERS_ID)
{
	$iblockCodeOffers = "kit_origami_offers";
    $iblockXmlIDOffers = "kit_origami_offers";
	//IBlock fields
	$iblock = new CIBlock;
	$arFields = Array(
		"ACTIVE" => "Y",
...
{
	$iblockCode = "kit_origami_catalog";
    $iblockXmlID = "kit_origami_catalog";
	//IBlock fields
	$iblock = new CIBlock;
	$arFields = Array(
		"ACTIVE" => "Y",
