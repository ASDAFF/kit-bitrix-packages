...
if (
    ...
    $icon_url_template = "<script>\n" .
        ...
        "}\n" .
        "</script>\n" .
        "<a class=\"subscribe-popup__button twitter\" href=\"http://twitter.com/home/?status=#PAGE_URL#+#PAGE_TITLE_ORIG#\" onclick=\"return twitter_click_" . $arResult["COUNTER"] . "('#PAGE_URL#');\" target=\"_blank\" title=\"" . $title . "\">" .
        "<div class=\"subscribe-popup__button-icon-wrapper\">" .
        "<img src=\"/local/templates/.default/components/bitrix/main.share/origami_default/images/twitter_new.png\">" .
        " </div>" .
    ...
    $icon_url_template = "<script>\n" .
        ...
        " </div>" .
        "<div class=\"subscribe-popup__button-description\"><span>" .
        GetMessage('BOOKMARK_HANDLER_TWITTER') .
        "</span></div>" .
        "</a>\n";
}
