...
if($arResult["MEDIA"] && $arParams["IMG_DEFAULT"] == 'Y')
{
    foreach($arResult["MEDIA"] as $key => $media) {
        ...
        $tempFile_370 = $_SERVER['DOCUMENT_ROOT'].'/upload/kit.instagram/370/' . $key . '/' . $arResult["LOGIN"]. '.jpg';
        ...
        $tempFile_540 = $_SERVER['DOCUMENT_ROOT'].'/upload/kit.instagram/540/' . $key . '/' . $arResult["LOGIN"]. '.jpg';
