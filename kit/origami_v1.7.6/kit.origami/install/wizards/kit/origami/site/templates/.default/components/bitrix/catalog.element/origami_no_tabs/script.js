(function(window){
	...
	window.JCCatalogElement = function(arParams)
	{
        ...
        if(document.querySelector('.detailed-tabs__video-list')) {
            this.initVideoSlider();
        }

        // this.scrollTo('.detailed-feat__menu-item a');
	};
	...
	window.JCCatalogElement.prototype = {
        ...
        scrollTo: function (item) {
            ...
            if(btnScroll) {
                ...
                btnScroll.on("click", scroll);
                btnScroll.on("touchstart", handlerTouchStart);
                btnScroll.on("touchend", handlerTouchEnd);
        ...
        initVideoSlider: function () {
            $('.detailed-tabs__video-list').slick({
                slidesToShow: 3,
...
;(function () {
    $(document).ready(function () {
        ...
        $( ".product-presence__property-btn" ).on('touchstart', function() {
            console.log('touch');
            var btn = $(this);
            if(!btn.hasClass('active')) {
                btn.addClass('active');
