    ...
    <div class="bx-authform">
        ...
        <form name="bform" method="post" target="_top" action="<?= $arResult["AUTH_URL"] ?>">
            ...
            <div class="bx-authform-formgroup-container">
                <div class="bx-authform-label-container"><? echo GetMessage("AUTH_LOGIN_EMAIL") ?>
            ...
            <div class="bx-authform-formgroup-container reset_pass-btn">
                <input type="submit" class="btn auth-btn" name="send_account_info"
