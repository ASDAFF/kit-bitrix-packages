					...
					<div class="col-md-12 sale-order-list-inner-container">
						...
						foreach ($order['PAYMENT'] as $payment)
						{
							...
							<div class="row sale-order-list-inner-row">
								...
								<div class="col-12 sale-order-list-inner-row-body">
									<div class="sale-order-list-payment">
										...
										if ($payment['PAID'] !== 'Y' && $order['ORDER']['LOCK_CHANGE_PAYSYSTEM'] !== 'Y')
										{
											...
											<a href="#" class="sale-order-list-change-payment" id="<?= htmlspecialcharsbx($payment['ACCOUNT_NUMBER']) ?>">
												<?= Loc::getMessage('SPOL_TPL_CHANGE_PAY_TYPE') ?> <i class="icon-nav_button"></i>
											</a>
											<?
										}
...
<!--											</div>-->
								...
								<div class="col-md-9 col-sm-8 col-xs-12 sale-order-list-shipment">
									...
									if (!empty($shipment['DELIVERY_ID']))
									{
										...
										<div class="sale-order-list-shipment-item">
                                            <span class="sale-order-list-shipment-item-name"><?=Loc::getMessage('SPOL_TPL_DELIVERY_SERVICE')?>:</span>
						...
						?>
						<div class="row sale-order-list-inner-row">
                            <div class="col-12 sale-order-list-about-container">
								<a class="sale-order-list-about-link" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_DETAIL"])?>">
                                    <?=Loc::getMessage('SPOL_TPL_MORE_ON_ORDER')?></a>
                                <div class="sale-order-list-repeat-and-cancel-link">
                                    <a class="sale-order-list-repeat-link" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_COPY"])?>">
                                        <i class="icon-return"></i>
                                        <?=Loc::getMessage('SPOL_TPL_REPEAT_ORDER')?></a>
                                    <a class="sale-order-list-cancel-link" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_CANCEL"])?>">
                                        <?=Loc::getMessage('SPOL_TPL_CANCEL_ORDER')?></a>
                                </div>
                            </div>
						</div>
					</div>
	...
	else
	{
		...
		foreach ($arResult['ORDERS'] as $key => $order)
		{
			...
			<div class="sale-order-list-container">
                <div class="sale-order-list-accomplished-title-container">
                        ...
                        <div class="sale-order-list-accomplished-date-container">
                            <?
                            if ($_REQUEST["show_canceled"] !== 'Y')
                            {
                                ?>
                ...
                <div class="sale-order-list-inner-accomplished">
                    <div class=" sale-order-list-about-accomplished">
                        <a class="sale-order-list-about-link" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_DETAIL"])?>">
                            <?=Loc::getMessage('SPOL_TPL_MORE_ON_ORDER')?>
                        </a>
                    </div>
                    <div class="sale-order-list-repeat-accomplished">
    ...
    <div class="personal_order_pagination">
