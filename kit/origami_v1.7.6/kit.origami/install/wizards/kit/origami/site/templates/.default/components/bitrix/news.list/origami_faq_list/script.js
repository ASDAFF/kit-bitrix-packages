...
function scrollToQuestionForm() {
    ...
    button.addEventListener("click", function () {
        ...
        // focus on form
        setTimeout(focusOnForm, 1000);
        function focusOnForm() {
            if (document.querySelector(".contacts-call-back-form .feedback_block__form_input")) {
                document.querySelector(".contacts-call-back-form .feedback_block__form_input").focus();
            }
        }
    })
}
