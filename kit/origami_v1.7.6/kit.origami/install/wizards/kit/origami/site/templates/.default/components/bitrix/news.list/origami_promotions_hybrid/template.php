...
<div class="promotion-block__wrapper main-container">
    <p class="puzzle_block__title fonts__middle_title">
        <?=$arParams["BLOCK_NAME"]?>
        <a href="<?=($arResult["ITEMS"][0]["LIST_PAGE_URL"]) ? $arResult["ITEMS"][0]["LIST_PAGE_URL"] : $arParams["LINK_TO_THE_FULL_LIST"]?>" title="<?=Loc::getMessage("KIT_PROMOTIONS_HYBRID_LINK_TEXT");?>" class="puzzle_block__link fonts__small_text">
            <?=Loc::getMessage("KIT_PROMOTIONS_HYBRID_LINK_TEXT");?>
            <i class="icon-nav_1"></i>
        </a>
    </p>

    <div class="promotion_block_two">
        <?
        $i = 0;
        ...
        ?>
            ...
            ?>
                <div class="promotion_block_two__item">
            <?elseif($i == 2):
            ...
            ?>
                <div class="promotion_block_two__item promotion_block_two__item--vertical">
            <?elseif($i == 4):
                $aClass = "promotion_block_two__link";
                $imgClass = "promotion_block_two__img";
                $orientation = "PREVIEW_PICTURE"; // VERTICAL_IMAGE
