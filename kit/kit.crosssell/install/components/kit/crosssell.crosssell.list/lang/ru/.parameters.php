<?
$MESS["AJAX_MODE_ORIGAMI"] = "Режим загрузки табов";
$MESS["BLOCK_TYPE"] = "Тип";
$MESS["SAME_PRODUCTS"] = "Похожие товары";
$MESS["COLLECTION"] = "Товарные коллекции";
$MESS["CROSSSELL"] = "Перекрестные продажи";
$MESS["COLLECTION"] = "Товарная коллекция";
...
$MESS["PRODUCT_ID"] = "ID продукта";
$MESS["CROSSSELL_ID"] = "ID товарного блока";
...
$MESS["SECTION_TEMPLATE"] = "Шаблон вывода элементов";
$MESS["SECTION_MODE"] = "Режим выбора перекрестных продаж";
$MESS["SECTION_MODE_Y"] = "Обрабатывать все выбранные условия";
$MESS["SECTION_MODE_N"] = "Использовать первое подходящее условие";
$MESS["SECTION_MODE_TIP"] = "Если выбран пункт \"Обрабатывать все выбранные условия\", то будут обрабатываться все выбранные условия из списка перекрестных продаж. 
...
$MESS["INTERRUPT_MODE"] = "Прекратить проверку условий при срабатывании";
$MESS["INTERRUPT_MODE_TIP"] = "Если отмечен checkbox, то при проверке условий по выбранным разделам и нахождении подходящего условия в разделе проверка по текущему разделу будет 
прекращена, элементы будут выведены в один блок/вкладку. После этого проверка будет продолжена по следующему разделу правил. Если checkbox не отмечен, то проверка останавливаться 
не будет и будут обработаны все подходящие условия";
$MESS["IBLOCK_SHOW_TABS"] = "Режим вывода перекрестных продаж";
$MESS["IBLOCK_SHOW_TABS_TABS"] = "Показывать вкладками";
$MESS["IBLOCK_SHOW_TABS_ROWS"] = "Показывать блоками";
$MESS["SHOW_SLIDER"] = "Вид отображения";
$MESS["SHOW_SLIDER_Y"] = "Слайдер";
$MESS["SHOW_SLIDER_N"] = "Список";
$MESS["ROOT_CATEGORY"] = "Без категории";
$MESS["PAGE_ELEMENT_COUNT"] = "Количество элементов в блоке";
$MESS["CROSSSELL_LIST"] = "Список перекрестных продаж";
$MESS["CROSSSELL_LIST_TIP"] = "Список перекрестных продаж";
?>