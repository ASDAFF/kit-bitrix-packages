...
\Bitrix\Main\Loader::registerAutoloadClasses('kit.crosssell',
    array(
        'KitCrosssellCatalogCondTree' => '/classes/general/CondTree.php',
        )
);
    ...
    public function generateCondition($_1367225421 = 0)
    {
        ...
        while ($_915215541 = $_1787891218->fetch()) {
            ...
            if ($_915215541['TYPE_BLOCK'] == 'CROSSSELL') {
                $_833598682 = new \KitCrosssellCatalogCondTree();
