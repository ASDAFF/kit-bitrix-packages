...
$mapsMarker = new Config\Widgets\File(
    ...
    [
        ...
        'preview'    => true,
        'NOTE'       => Loc::getMessage(KitRegions::moduleId.'_WIDGET_MAPS_MARKER_NOTE')
    ]
);
...
$mapsGoogleApi = new Config\Widgets\Str('MAPS_GOOGLE_API', [
    'NOTE' => Loc::getMessage(KitRegions::moduleId.'_WIDGET_MAPS_GOOGLE_API_NOTE'),
]);
...
$locationType = new Config\Widgets\Select('LOCATION_TYPE',
    ['NOTE' => Loc::getMessage(KitRegions::moduleId.'_WIDGET_LOCATION_TYPE_NOTE'),]);
