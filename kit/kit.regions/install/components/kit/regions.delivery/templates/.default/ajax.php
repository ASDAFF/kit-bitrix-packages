...
<div class="select-city__modal-wrap">
    ...
    <input class="select-city__input" type="region-input" name="" id="region-input" placeholder="<?=Loc::getMessage(KitRegions::moduleId.'_WRITE_SITY')?>" data-entity="filter-regions">
