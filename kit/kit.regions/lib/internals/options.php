	...
	public static function getMap()
	{
		return array(
			'CODE' => array(
				...
				'title' => Loc::getMessage(\KitRegions::moduleId.'_OPTIONS_ENTITY_CODE_FIELD'),
			),
			'VALUE' => array(
				'data_type' => 'text',
				'title' => Loc::getMessage(\KitRegions::moduleId.'_OPTIONS_ENTITY_VALUE_FIELD'),
			),
			'SITE_ID' => array(
				'data_type' => 'string',
				'primary' => true,
				'validation' => array(__CLASS__, 'validateSiteId'),
				'title' => Loc::getMessage(\KitRegions::moduleId.'_OPTIONS_ENTITY_SITE_ID_FIELD'),
			),
		);
	}
	/**
