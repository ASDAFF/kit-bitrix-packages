...
class OpengraphPageMetaTable extends DataManager {
    ...
    public static function getTableName() {
        return 'b_kit_opengraph_page_meta';
    }
    ...
    public static function getMap() {
        return array(
            ...
            'ACTIVE_OG' => array(
                ...
                'title' => Loc::getMessage('KIT_OPENGRAPH_PAGE_META_ENTITY_ACTIVE_OG_FIELD'),
            ),
            'OG_IMAGE_TYPE' => array(
                'data_type' => 'string',
                'title' => Loc::getMessage('KIT_OPENGRAPH_OG_IMAGE_TYPE'),
            ),
            'OG_IMAGE_WIDTH' => array(
                'data_type' => 'string',
                'title' => Loc::getMessage('KIT_OPENGRAPH_OG_IMAGE_WIDTH'),
            ),
            'OG_IMAGE_HEIGHT' => array(
                'data_type' => 'string',
                'title' => Loc::getMessage('KIT_OPENGRAPH_OG_IMAGE_HEIGHT'),
            ),
            'OG_IMAGE_SECURE_URL' => array(
                'data_type' => 'string',
                'title' => Loc::getMessage('KIT_OPENGRAPH_OG_IMAGE_SECURE_URL'),
            ),
            'OG_DESCRIPTION' => array(
                'data_type' => 'string',
                'title' => Loc::getMessage('KIT_OPENGRAPH_OG_DESCRIPTION'),
            ),
            'OG_TITLE' => array(
                'data_type' => 'string',
                'title' => Loc::getMessage('KIT_OPENGRAPH_OG_OGP_TITLE'),
            ),
            'OG_URL' => array(
                'data_type' => 'string',
                'title' => Loc::getMessage('KIT_OPENGRAPH_OG_URL'),
            ),
            'OG_TYPE' => array(
                'data_type' => 'string',
                'title' => Loc::getMessage('KIT_OPENGRAPH_OG_TYPE'),
            ),
            'OG_IMAGE' => array(
                'data_type' => 'integer',
                'title' => Loc::getMessage('KIT_OPENGRAPH_OG_IMAGE'),
            ),
            'OG_PROPS_ACTIVE' => array(
                'data_type' => 'text',
                'title' => Loc::getMessage('KIT_OPENGRAPH_PAGE_META_ENTITY_OG_PROPS_ACTIVE_FIELD'),
            ),
            'ACTIVE_TW' => array(
                'data_type' => 'boolean',
                'values' => array(
                ...
                'title' => Loc::getMessage('KIT_OPENGRAPH_PAGE_META_ENTITY_ACTIVE_TW_FIELD'),
            ),
            'TW_CARD' => array(
                'data_type' => 'string',
                'title' => Loc::getMessage('KIT_OPENGRAPH_TW_CARD'),
            ),
            'TW_TITLE' => array(
                'data_type' => 'string',
                'title' => Loc::getMessage('KIT_OPENGRAPH_TW_TITLE'),
            ),
            'TW_SITE' => array(
                'data_type' => 'string',
                'title' => Loc::getMessage('KIT_OPENGRAPH_TW_SITE'),
            ),
            'TW_DESCRIPTION' => array(
                'data_type' => 'string',
                'title' => Loc::getMessage('KIT_OPENGRAPH_TW_DESCRIPTION'),
            ),
            'TW_IMAGE_ALT' => array(
                'data_type' => 'string',
                'title' => Loc::getMessage('KIT_OPENGRAPH_TW_IMAGE_ALT'),
            ),
            'TW_CREATOR' => array(
                'data_type' => 'string',
                'title' => Loc::getMessage('KIT_OPENGRAPH_TW_CREATOR'),
            ),
            'TW_PROPS_ACTIVE' => array(
                'data_type' => 'text',
                'title' => Loc::getMessage('KIT_OPENGRAPH_PAGE_META_ENTITY_TW_PROPS_ACTIVE_FIELD'),
            ),
            'TW_IMAGE' => array(
                'data_type' => 'integer',
                'title' => Loc::getMessage('KIT_OPENGRAPH_TW_IMAGE'),
            ),
            'TIMESTAMP_X' => array(
                'data_type' => 'datetime',
            ...
            'CATEGORY_ID' => array(
                'data_type' => 'integer',
                'title' => Loc::getMessage('KIT_OPENGRAPH_ENTITY_CATEGORY_ID_FIELD'),
            ),
            'SITE_ID' => array(
                'data_type' => 'string',
                'required' => true,
            ...
            'ORDER' => array(
                'data_type' => 'string',
                'title' => Loc::getMessage('KIT_OPENGRAPH_PAGE_META_ENTITY_ORDER_FIELD'),
            )
        );
    }
    ...
    public static function saveImage($arImg, $case = 'OG_IMAGE') {
        ...
        if(is_array($arImg)) {
            ...
            $fid = \CFile::SaveFile(\CIBlock::makeFileArray($arImg), "kit_opengraph");
        }
...
//        else if(!isset($_REQUEST['apply_filter']) && !isset($arFilter['FIND']) || (isset($_POST['clear_nav']) && $_POST['clear_nav'] == 'Y' && empty($arFilter['FIND'])))
    ...
    private function fillErrors(array $arFields) {
        foreach($arFields as $key => $val) {
            $this->errors[$key] = Loc::getMessage('KIT_OPENGRAPH_PAGE_META_ENTITY_REQUIRED_FIELD_ERROR')." [".Loc::getMessage('KIT_OPENGRAPH_'.$key)."]";
        }
    }
