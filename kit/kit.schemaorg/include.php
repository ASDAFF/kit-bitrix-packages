...
\Bitrix\Main\Loader::registerAutoloadClasses('kit.schemaorg', array('SchemaMain' => '/classes/schema_main.php', 'SchemaCore' => '/classes/schema_core.php', 'SchemaSettings' => '/classes/schema_settings.php',));
...
//        return static::$_745644782;
    ...
    {
        $_1334607185 = $_SERVER["DOCUMENT_ROOT"] . '/bitrix/modules/kit.schemaorg/admin/kit_schemaorg_entities/';
        return $_1334607185;
    }
    ...
    public function makeSingleDropDownField($_625660885, $_668064939, $_1300306693, $_2051586567, $_211608319, $_1188926000, $_383961041 = false)
    {
        ...
        if (file_exists(self::getPath() . strtolower($_1188926000[$_668064939]['@type']) . '.php')) {
            ...
            echo KitSchema::getBlockContent($_1188926000[$_668064939], $_1334607185, $_2051586567 . '[' . $_668064939 . ']');
        } else {
            echo '' . '' . '' . '';
        }
        ...
        if (isset($_1188926000[$_668064939])) {
            foreach ($_1188926000[$_668064939] as $_745720950 => $_1486268347) {
                if (file_exists(self::getPath() . strtolower($_1188926000[$_668064939][$_745720950]['@type']) . '.php')) {
                    ...
                    echo KitSchema::getBlockContent($_1486268347, $_1334607185, $_2051586567 . '[' . $_668064939 . ']' . '[' . $_745720950 . ']', true);
                }
            }
...
class DataManagerEx_SchemaOrg extends DataManager
{
    ...
    {
        if (!KitSchema::getDemo()) return new Bitrix\Main\ORM\Query\Result(parent::query(), new \Bitrix\Main\DB\ArrayResult(array())); else return parent::getList($_1463948715);
    }

    public static function getById($_1702899765 = "")
    {
        if (!KitSchema::getDemo()) return new \CDBResult; else return parent::getById($_1702899765);
    }

    public static function add(array $_1137271263 = array())
    {
        if (!KitSchema::getDemo()) return new \Bitrix\Main\Entity\AddResult(); else return parent::add($_1137271263);
    }

    public static function update($_1702899765 = "", array $_1137271263 = array())
    {
        if (!KitSchema::getDemo()) return new \Bitrix\Main\Entity\UpdateResult(); else return parent::update($_1702899765, $_1137271263);
    }
}
 ?>