...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "isAccessoryOrSparePartFor",
    array(
        '' => '...',
        'product' => 'Product',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "isConsumableFor",
    array(
        '' => '...',
        'product' => 'Product',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "manufacturer",
    array(
        '' => '...',
        'organization' => 'Organization'
    ),
