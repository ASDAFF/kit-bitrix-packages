...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "hoursAvailable",
    array(
        '' => '...',
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "category",
    array(
        '' => '...',
        'text' => 'Text',
        'thing' => 'Thing',
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "provider",
    array(
        '' => '...',
        'person' => 'Person',
        'organization' => 'Organization',
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "serviceOutput",
    array(
        '' => '...',
        'thing' => 'Thing',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "isRelatedTo",
    array(
        '' => '...',
        'service' => 'Service',
        'product' => 'Product',
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "isSimilarTo",
    array(
        '' => '...',
        'service' => 'Service',
        'product' => 'Product',
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "broker",
    array(
        '' => '...',
        'person' => 'Person',
        'organization' => 'Organization',
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "produces",
    array(
        '' => '...',
        'thing' => 'Thing',
    ),
...
//$tabControl = KitSchema::makeSingleDropDownField($tabControl, "serviceAudience",
//    array(
//        '' => '...',
//        'audience' => 'Audience',
//    ),
