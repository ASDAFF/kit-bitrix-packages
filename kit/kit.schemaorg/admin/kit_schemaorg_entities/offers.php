...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "addOn",
    array(
        '' => '...',
        'offer' => 'Offer',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "availableAtOrFrom",
    array(
        '' => '...',
        'place' => 'Place',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "itemOffered",
    array(
        '' => '...',
        'product' => 'Product',
        'service' => 'Service',
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "priceSpecification",
    array(
        '' => '...',
        'pricespecification' => 'PriceSpecification',
    ),
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "seller",
    array(
        '' => '...',
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "eligibleRegion",
    array(
        '' => '...',
        'text' => 'Text',
        'place' => 'Place',
...
$tabControl = KitSchema::makeSingleDropDownField($tabControl, "ineligibleRegion",
    array(
        '' => '...',
        'text' => 'Text',
        'place' => 'Place',
