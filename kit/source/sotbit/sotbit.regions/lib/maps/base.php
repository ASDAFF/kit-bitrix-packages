...
class Base
{
    ...
    {
        $types = [
            'yandex' => Loc::getMessage(\SotbitRegions::moduleId.'_MAPS_TYPE_YANDEX'),
            'google' => Loc::getMessage(\SotbitRegions::moduleId.'_MAPS_TYPE_GOOGLE'),
        ];
    ...
    {
        $mapMarkerFields = [
            'NAME' => GetMessage(\SotbitRegions::moduleId.'_MAPS_MARKER_FIELDS_NAME'),
            'CODE' => GetMessage(\SotbitRegions::moduleId.'_MAPS_MARKER_FIELDS_CODE'),
        ];
        $arFields = \SotbitRegions::getUserTypeFields();
