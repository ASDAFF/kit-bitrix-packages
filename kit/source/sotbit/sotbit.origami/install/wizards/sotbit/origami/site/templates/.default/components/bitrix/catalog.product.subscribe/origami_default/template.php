...
?>
    <script src="<?=CUtil::GetAdditionalFileURL($templateFolder.'/script.js');?>"></script>
...
$arResult['BUTTON_CLASS'] = 'product-item-detail-buy-button main_btn sweep-to-right btn-sm';
...
if($showSubscribe):?>
	...
	<script type="text/javascript">
		BX.message({
			...
			CPST_TITLE_ALREADY_SUBSCRIBED2: '<?=GetMessageJS('CPST_TITLE_ALREADY_SUBSCRIBED2');?>',
			CPST_TITLE_ALREADY_SUBSCRIBED3: '<?=GetMessageJS('CPST_TITLE_ALREADY_SUBSCRIBED3');?>',
