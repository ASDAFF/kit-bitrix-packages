	...
	<div class="sale-order-detail">
		...
		if ($arParams['GUEST_MODE'] !== 'Y')
		{
			...
			<a class="sale-order-detail-back-to-list-link-up" href="<?= htmlspecialcharsbx($arResult["URL_TO_LIST"]) ?>">
				<i class="icon-nav_left"></i> <?= Loc::getMessage('SPOD_RETURN_LIST_ORDERS') ?>
			</a>
			<?
		}
		?>
		<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-general">
			...
			<div class="row sale-order-detail-about-order">
				<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-about-order-inner-container">
					<div class="row sale-order-detail-about-order-inner-container-main-info">
						<div class="col-12 col-sm-9 sale-order-detail-about-order-inner-container-name">
                                    <div class="sale-order-detail-avatar">
                                        <span class="icon-avatar1"></span>
                                    </div>
                                    <div class="sale-order-detail-info">
                                        <span class="sale-order-detail-about-order-inner-container-name-title">
										<?
                                        ...
                                        <span class="sale-order-detail-about-order-inner-container-name-detail">
										<?
                                        if (strlen($userName))
                                        {
                                        ...
                                        <span class="sale-order-detail-about-order-inner-container-status-title">
                                            <?= Loc::getMessage('SPOD_LIST_CURRENT_STATUS', array(
                                                '#DATE_ORDER_CREATE#' => $arResult["DATE_INSERT_FORMATED"]
                                            )) ?>
                                        </span>
                                            <span class="sale-order-detail-about-order-inner-container-status-detail">
                                            <?
                                        ...
                                        <span class="sale-order-detail-about-order-inner-container-price-title">
                                            <?= Loc::getMessage('SPOD_ORDER_PRICE')?>:
                                        </span>
                                            <span class="sale-order-detail-about-order-inner-container-price-detail">
                                            <?= $arResult["PRICE_FORMATED"]?>
                                        </span>
                                        </div>
								...
								{
									?>
									<div class="col-12 col-sm-3 sale-order-detail-about-order-inner-container-repeat">
					...
					<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-about-order-inner-container-details">
								<div class="sale-order-detail-about-order-inner-container-details-block">
			...
			<div class="row sale-order-detail-payment-options">
				<div class="col-md-12 col-sm-12 col-xs-12 ">
					...
					<div class="row sale-order-detail-payment-options-container sale-order-detail-payment-options-inner-container">
						<div class="col-md-12 col-sm-12 col-xs-12  ">
							<div class="row">
								<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-payment-options-info">
									<div class="row">
										<div class="sale-order-detail-payment-options-info-image">
                                    ...
                                    <div class="row payment-options-methods-row">
                                        <div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-payment-options-methods">
                                            <div class="row sale-order-detail-payment-options-methods-information-block">
                                                <div class="col-md-9 col-sm-7 col-xs-12 sale-order-detail-payment-options-methods-info">
                                                ...
                                                {
                                                    ?>
                                                    <div class="col-md-3 col-sm-12 col-xs-12 sale-order-detail-payment-options-methods-button-container">
                                                        <?
								...
								<?
									foreach ($arResult['SHIPMENT'] as $shipment)
									{
										?>
                                                        ...
                                                        <div class="row sale-order-detail-payment-options-shipment">
                                                            <div class="sale-order-detail-payment-options-shipment-flex">
                                                                <div class="sale-order-detail-payment-options-shipment-image-container">
                                                                    <?
                                                                        if (strlen($shipment['DELIVERY']["SRC_LOGOTIP"]))
                                                                        {
                                                                            ?>
                                                                            <i class="icon-shipped1"></i>
								...
								<div class="sale-order-detail-order-table-fade sale-order-detail-order-table-fade-right">
									<div style="width: 100%; overflow-x: auto; overflow-y: hidden;">
										<div class="sale-order-detail-order-item-table">
											...
											{
												?>
												<div class="sale-order-detail-order-item-tr sale-order-detail-order-basket-info sale-order-detail-order-item-tr-first" style="margin-top: 10px;">
...
<!--				</div>-->
			...
			<div class="row sale-order-detail-total-payment">
				<div class="sale-order-detail-total-payment-container">
                    <div class="sale-order-detail-total-payment-container-item">
                        <?
                        if ($arResult['PRODUCT_SUM_FORMATED'] != $arResult['PRICE_FORMATED'] && !empty($arResult['PRODUCT_SUM_FORMATED']))
                        {
                            ...
                            :
                            <?
                            if (floatval($arResult["PRODUCT_SUM_FORMATED"]))
                            {
                                ?>
                                <span class="sale-order-detail-total-payment-list-right-item"><?=$arResult['PRODUCT_SUM_FORMATED']?></span>
                                <?
                            }
                        } ?>
                    </div>
                    <div class="sale-order-detail-total-payment-container-item">
                        ...
                        {
                            ?>
                            <span class="sale-order-detail-total-payment-list-right-item"><?= $arResult["PRICE_DELIVERY_FORMATED"] ?></span>
                            <?
                        }
                        ?>
                    </div>
                    <div class="sale-order-detail-total-payment-container-item">
                        ...
                        <span class="sale-order-detail-total-payment-list-right-item"><?=$arResult['PRICE_FORMATED']?></span>
                    </div>
