                ...
                <div class="product-preview-photo-block-wrapper">
                    ...
                    <script>
                        $(document).ready(function () {
                            $(document).off('click', '.main_info_preview_product .block-property-color-item', window.changeColor);
                            $(document).off('click', '.main_info_preview_product .block-property-text-item', window.prewiewPropertyText);
                            $(document).off('click', '.main_info_preview_product .dropdown-props', window.dropdownProps);

                            window.detailedSliderView();
                            $(document).on('click', '.main_info_preview_product .block-property-color-item', window.changeColor);
                            $(document).on('click', '.main_info_preview_product .block-property-text-item', window.prewiewPropertyText);
                            $(document).on('click', '.main_info_preview_product .dropdown-props', window.dropdownProps);
                        });
                    </script>
                            ...
                            <a href="javascript:void(0);" class="product_preview__nav-prev" onclick='quickViewPreview("<?=$arResult['PREV_ITEM']['DETAIL_PAGE_URL']?>");'>
                                <div class="product_preview__nav-wrapper">
                                    ...
                                    <div class="product_preview__nav-content product_preview__nav-content--prev">
                                        <?if($arResult['PREV_ITEM']['PREVIEW_PICTURE']):?>
                                            <div class="product_preview__nav-img">
                                                <img src="<?=CFile::GetPath($arResult['PREV_ITEM']['PREVIEW_PICTURE']);?>" alt="">
                                            </div>
                                        <?endif;?>
                            ...
                            <a href="javascript:void(0);" class="product_preview__nav-next" onclick='quickViewPreview("<?=$arResult['NEXT_ITEM']['DETAIL_PAGE_URL']?>");'>
                                <div class="product_preview__nav-wrapper product_preview__nav-wrapper--next">
                                    ...
                                    <div class="product_preview__nav-content product_preview__nav-content--next">
                                        <?if($arResult['NEXT_ITEM']['PREVIEW_PICTURE']):?>

                                            <div class="product_preview__nav-img">
                                                <img src="<?=CFile::GetPath($arResult['NEXT_ITEM']['PREVIEW_PICTURE']);?>" alt="">
                                            </div>
