                                    ...
                                    if (!empty($actualItem['MORE_PHOTO']))
                                    {
                                        foreach($actualItem['MORE_PHOTO'] as $key => $photo)
                                        {
                                            ...
                                            if ($key == 0 && $arResult['VIDEO'])
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <div class="detail-big-video" data-value="<?= $i ?>">
                                                        <?= $video ?>
                                                    </div>
                                                    <?
                                                }
                                ...
                                foreach ($arResult['OFFERS'] as $keyOffer => $offer)
                                {
                                    ...
                                    <div class="product-item-detail-slider-controls-block" id="<?= $itemIds['SLIDER_CONT_OF_ID'].$offer['ID'] ?>" style="display: <?= $strVisible ?>;">
                                        ...
                                        foreach ($offer['MORE_PHOTO'] as $keyPhoto => $photo)
                                        {
                                            ...
                                            ?>
                                            <div class="product-item-detail-slider-controls-image<?= ($keyPhoto
                                            == 0 ? ' active' : '') ?>"
                                            ...
                                            if ($keyPhoto == 0 && $arResult['VIDEO'])
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <div class="product-item-detail-slider-controls-video" data-entity="video" data-value="<?= $i ?>">
				...
				<div class="row">
                    ...
                    $APPLICATION->IncludeComponent(
                        ...
                        [
                            'AREA_FILE_SHOW' => 'file',
                            'PATH' => SITE_DIR
                                . "include/sotbit_origami/files/share/share.php",
        ...
        if ($arResult['TABS'])
        {
            ...
            <div class="detailed-tabs js-tabs-wrapper">
                <ul class="detailed-tabs__tabs js-tabs">
                    ...
                    {
                        ?>
                        <li class="detailed-tabs__tabs-item js-tabs-item <?= ($i == 0) ? 'active' : '' ?>"
                            id="TAB_<?= $tab['TYPE'] ?>">
                            <p><?= $tab['NAME'] ?></p>
                        </li>
                        <?
                    ...
                    foreach ($arResult['TABS'] as $i => $tab)
                    {
                        switch ($tab['TYPE'])
                        {
                            case 'DESCRIPTION':
                                ...
                                {
                                    ?>
                                    <div class="detailed-tabs__content detailed-tabs__description <?= ($i == 0) ? 'active' : '' ?> js-tabs-content">
                                        <?
                            ...
                            case 'PROPERTIES':
                                ?>
                                <div class="detailed-tabs__content detailed-tabs__options <?= ($i == 0) ? 'active' : '' ?> js-tabs-content">
                                    <?
                            ...
                            case 'DELIVERY':
                                ?>
                                <div class="detailed-tabs__content detailed-tabs__delivery <?= ($i == 0) ? 'active' : '' ?> js-tabs-content" id="DELIVERY_CONTENT">
                                <?
                                $startAjax = 'N';
                                if($i == 0)
                                    $startAjax = 'Y';
                            ...
                            case 'COMMENTS':
                                ?>
                                <div class="detailed-tabs__content detailed-tabs__reviews <?= ($i == 0) ? 'active' : '' ?> js-tabs-content">
                                    <?
                            ...
                            case 'VIDEO':
                                ?>
                                <div class="detailed-tabs__content detailed-tabs__video <?= ($i == 0) ? 'active' : '' ?> js-tabs-content">
                                    <?
                            ...
                            case 'AVAILABLE':
                                ?>
                                <div class="detailed-tabs__content detailed-tabs__availability <?= ($i == 0) ? 'active' : '' ?> js-tabs-content">
                            ...
                            case 'DOCS':
                                ?>
                                <div class="detailed-tabs__content detailed-tabs__documents <?= ($i == 0) ? 'active' : '' ?> js-tabs-content">
                                    <?
                                    if ($arResult['DOCS'])
                                    {
                                        ?>
...
<!--                    </div>-->
<!--                    <script>-->
<!--                        window.initSliderArticle = function (container) {-->
<!--                            let mobileSlider = document.querySelector('.detailed-tabs__articles.clone .swiper-container');-->
<!--                            let sliders = new Swiper(mobileSlider, {-->
<!--                                observer: true,-->
<!--                                observeParents: true,-->
<!--                                slidesPerView: 2,-->
<!--                                spaceBetween: 30,-->
