...
<div class="puzzle_block news-block__wrapper main-container">
    ...
    <div class="news_block_three">
        <!-- <div class="news_block_three__wrapper"> -->
            ...
            <?foreach(array_slice($arResult["ITEMS"], 0, 7) as $arItem):?>
                ...
                ?>
                <?if($i <= 2):?>
                    <div class="news_block_three__item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                ...
                <?else:?>
                    <?if($i == 3):?>
                        <div class="news_block_three__others">
                            <p class="news_block_three__others_title"><?=Loc::getMessage("SOTBIT_NEWS_ADDITIONAL_TEXT");?></p>
                    <?endif;?>
