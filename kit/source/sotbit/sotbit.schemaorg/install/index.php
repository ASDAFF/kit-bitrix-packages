...
Class sotbit_schemaorg extends CModule
{
    const MODULE_ID = 'sotbit.schemaorg';
    var $MODULE_ID = 'sotbit.schemaorg';
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = Loc::getMessage('SOTBIT_SCHEMA_MODULE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('SOTBIT_SCHEMA_MODULE_DESC');
        $this->PARTNER_NAME = Loc::getMessage('SOTBIT_SCHEMA_PARTNER_NAME');
        $this->PARTNER_URI = Loc::getMessage('SOTBIT_SCHEMA_PARTNER_URI');
    }
    ...
    {
        EventManager::getInstance()->unregisterEventHandler('main', 'OnBeforeProlog', self::MODULE_ID, '\Sotbit\Schemaorg\EventHandlers', 'OnBeforeProlog');
        EventManager::getInstance()->registerEventHandler('main', 'OnEndBufferContent', self::MODULE_ID, '\Sotbit\Schemaorg\EventHandlers', 'ChangeContent');
        EventManager::getInstance()->registerEventHandler('main', 'OnBuildGlobalMenu', self::MODULE_ID, '\Sotbit\Schemaorg\EventHandlers', 'OnBuildGlobalMenuHandler');
        return true;
    }
    ...
    {
        EventManager::getInstance()->unregisterEventHandler('main', 'OnEndBufferContent', self::MODULE_ID, '\Sotbit\Schemaorg\EventHandlers', 'ChangeContent');
        EventManager::getInstance()->unregisterEventHandler('main', 'OnBuildGlobalMenu', self::MODULE_ID, '\Sotbit\Schemaorg\EventHandlers', 'OnBuildGlobalMenuHandler');
        return true;
    }
