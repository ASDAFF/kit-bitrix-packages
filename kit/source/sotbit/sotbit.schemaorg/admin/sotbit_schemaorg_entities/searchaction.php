...
$langPrefix = 'SOTBIT_SCHEMA_SEARCHACTION_';
...
?>
    <tr class="adm-detail-file-row">
        <td colspan="2" style="text-align: center">
            <input type="hidden" name="<?=$key ? $key."[@type]" : "@type"?>" value="SearchAction"/>
        </td>
    </tr>
<?
$tabControl->EndCustomField("type_BLOCK");

$tabControl = SotbitSchema::makeSingleDropDownField($tabControl, "query-input",
    array(
        '' => '...',
...
require (dirname(__FILE__).'/blocks/action.php');
