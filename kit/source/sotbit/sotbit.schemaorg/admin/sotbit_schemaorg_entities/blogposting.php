...
$langPrefix = 'SOTBIT_SCHEMA_BLOGPOSTING_';
...
?>
    <tr class="adm-detail-file-row">
        <td colspan="2" style="text-align: center">
            <input type="hidden" name="<?=$key ? $key."[@type]" : "@type"?>" value="BlogPosting"/>
        </td>
    </tr>
<?
$tabControl->EndCustomField("type_BLOCK");

$tabControl = SotbitSchema::makeSingleDropDownField($tabControl, "sharedContent",
    array(
        '' => '...',
