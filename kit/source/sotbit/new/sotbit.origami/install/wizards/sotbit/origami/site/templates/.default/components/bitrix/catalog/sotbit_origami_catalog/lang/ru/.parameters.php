...
$MESS["CPT_BC_SECTIONS_ROOT_VIEW"] = "Максимальная отображаемая глубина разделов на корневой странице каталога";
...
$MESS["CP_BC_TPL_DETAIL_IMAGE_RESOLUTION_4_BY_3"] = "4:3";
...
$MESS['CP_BC_TPL_ACTION_PRODUCTS'] = 'Действия над товарами';
$MESS['CP_BC_TPL_FILL_ITEM_ALL_PRICES'] = 'Отображать все доступные для пользователя цены';
$MESS['CP_BC_TPL_FROM_ADMIN'] = "Подтягивать параметры из админных настроек";
$MESS['CP_BC_TPL_VARIANT_LIST_VIEW'] = "Вид отображения карточки товара в списке";
$MESS['CP_BC_TPL_MOBILE_VIEW_MINIMAL'] = "Минимизировать карточки товаров в мобильной версии";
$MESS['CP_BC_TPL_MOBILE_VIEW_MINIMAL_Y'] = 'Да';
$MESS['CP_BC_TPL_MOBILE_VIEW_MINIMAL_N'] = 'Нет';
?>
