...
$MESS ['FORM_ADDOK'] = "Веб-форма успешно отправлена.";

$MESS ['FORM_SUBMIT'] = "Отправить";
$MESS ['FORM_RESET'] = "Отмена";
...
$MESS ['SOTBIT_FORM_TITLE_1'] = "Воспользуйтесь формой, чтобы задать ваш вопрос";
