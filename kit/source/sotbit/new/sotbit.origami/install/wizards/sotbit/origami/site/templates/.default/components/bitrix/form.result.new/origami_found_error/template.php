                    ...
                    <? if ($arQuestion['STRUCTURE'][0]['FIELD_TYPE'] == 'textarea'): ?>
                        <div class="found-error-popup__textarea main-textarea-md__wrapper">
                            <textarea
                                ...
                                id="found-error-textarea_<?= $arQuestion['STRUCTURE'][0]['ID'] ?>"
                                onchange="isInputFilled(this)"></textarea>
                            <label class="main-label-textarea-md" for="found-error-textarea_<?= $arQuestion['STRUCTURE'][0]['ID'] ?>">
                                <?= GetMessage('COMMENT'); ?></label>
                        </div>
...
<script>
    ...
    function addFile () {
        ...
        document.querySelector('.inputfile').removeEventListener('change', addFile);
        document.querySelector('.inputfile').addEventListener('change', addFile);
    }
    document.querySelector('.inputfile').addEventListener('change', addFile);
