        ...
        <?if($arItem["IS_PARENT"]):?>
            ...
            <?else:?>
                <li class="category_link__active_content_item <?if($arItem["SELECTED"]):?>active<?endif;?> <?if(isset($arItem["CHILD_SELECTED"])):?>current<?endif;?>">
                    <? if($arItem["LINK"] != $page): ?>
                        <a href="<?= $arItem["LINK"] ?>" title="<?=$arItem["TEXT"]?>" class="category_link__active_content_item_link origami_icons_button">
                            <?=$arItem["TEXT"]?>
                        </a>
                    <? else: ?>
                        <span class="category_link__active_content_item_link origami_icons_button">
                            <?=$arItem["TEXT"]?>
                        </span>
                    <? endif ?>
            ...
            <?if($arItem["PERMISSION"] > "D"):?>
                <?if($arItem["DEPTH_LEVEL"] == 1):?>
                    <li class="visible-links__item <?if($arItem["SELECTED"]):?>active<?endif;?> <?if(isset($arItem["CHILD_SELECTED"])):?>current<?endif;?>">
                        ...
                        <? else: ?>
                            <span class="visible-links__item_span fonts__small_text">
                                <?=$arItem["TEXT"]?>
                            </span>
                        <? endif ?>
                    </li>
                <?else:?>
                    <li class="category_link__active_content_item <?if($arItem["SELECTED"]):?>active<?endif;?> <?if(isset($arItem["CHILD_SELECTED"])):?>current<?endif;?>">
                        ...
                        <? else: ?>
                            <span class="category_link__active_content_item_link">
                                <?=$arItem["TEXT"]?>
                            </span>
                        <? endif ?>
                    </li>
