...
return [
	'block' =>
		[
			'name' => \Bitrix\Main\Localization\Loc::getMessage('BLOG_TITLE'),
			'section' => 'blog',
		],
    'fields' =>
		[
    ...
    'ext'    =>
        [
            'js'  =>
                [ $_SERVER['DOCUMENT_ROOT'].SITE_DIR.'include/blocks/blog/script.js',
                ],
            'css' =>
                [ $_SERVER['DOCUMENT_ROOT'].'/local/templates/.default/components/bitrix/news.list/origami_blog_simple/style.css',
                ],
        ],
	'style'  =>
		[
