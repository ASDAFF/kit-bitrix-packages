...
return [
	'block' =>
		[
			'name' => \Bitrix\Main\Localization\Loc::getMessage('BLOG_TITLE_IMAGES_AND_LIST_LEFT'),
			'section' => 'blog',
		],
    'fields' =>
		[
	...
	'ext' =>
		[
			...
			'css' =>
				[$_SERVER['DOCUMENT_ROOT'].'/local/templates/.default/components/bitrix/news.list/origami_blog_images_and_list_left/style.css'
				],
		],
	'style'  =>
		[
