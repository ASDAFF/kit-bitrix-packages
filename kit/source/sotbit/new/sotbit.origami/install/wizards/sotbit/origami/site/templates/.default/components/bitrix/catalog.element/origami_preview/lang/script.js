...
// 	$(".block-basic-property-link").on("click", function (event) {
// 		$( "#prop_item" ).trigger( "click" );
...
// 		if(!$(this).hasClass('active')){
// 			if($('#DELIVERY_CONTENT').html().trim().length == 0){
//                 var defaultData = {
//                     siteId: $('#DELIVERY_CONTENT').data('site-id'),
//                     template: $('#DELIVERY_CONTENT').data('template'),
//                     parameters: $('#DELIVERY_CONTENT').data('params')
//                 };
//                 var data = {
//                 };
...
//                         $('#DELIVERY_CONTENT').html(result);
//                         removeLoadersMore($('#DELIVERY_CONTENT'));
//                     }, this)
//                 });
//             }
// 		}
