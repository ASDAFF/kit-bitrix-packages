...
Asset::getInstance()->addCss(SITE_DIR . "local/templates/.default/components/bitrix/news/sotbit_origami_brands/style.css");
...
<div class="brands_list">
	<div class="row personal_block_component">
		...
		<div class="col-sm-12 personal_title_block">
			<p class="personal_title fonts__middle_title">
