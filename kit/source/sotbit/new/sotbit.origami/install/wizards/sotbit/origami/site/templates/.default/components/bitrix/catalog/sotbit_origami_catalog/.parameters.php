...
$arTemplateParameters = array(
    "SECTIONS_ROOT_VIEW" => array(
        "PARENT" => "SECTIONS_SETTINGS",
        "NAME" => GetMessage('CPT_BC_SECTIONS_ROOT_VIEW'),
        "TYPE" => "STRING",
        "DEFAULT" => "1",
    ),
...
$arTemplateParameters['VARIANT_LIST_VIEW'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage("CP_BC_TPL_VARIANT_LIST_VIEW"),
	'TYPE' => 'LIST',
...
$e =
$arVaraintMobileView = array(
    'ADMIN' => GetMessage('CP_BC_TPL_FROM_ADMIN'),
    'Y' => GetMessage('CP_BC_TPL_MOBILE_VIEW_MINIMAL_Y'),
    'N' => GetMessage('CP_BC_TPL_MOBILE_VIEW_MINIMAL_N')
);

$arTemplateParameters['MOBILE_VIEW_MINIMAL'] = array(
    'PARENT' => 'VISUAL',
    'NAME' => GetMessage("CP_BC_TPL_MOBILE_VIEW_MINIMAL"),
    'TYPE' => 'LIST',
    'VALUES' => $arVaraintMobileView,
    'ADDITIONAL_VALUES' => 'N'
);
...
$arTemplateParameters['DETAIL_IMAGE_RESOLUTION'] = array(
	...
	'VALUES' => array(
        ...
        '4by3' => GetMessage('CP_BC_TPL_DETAIL_IMAGE_RESOLUTION_4_BY_3'),
...
$arTemplateParameters['ACTION_PRODUCTS'] = array(
    ...
    'NAME' => GetMessage('CP_BC_TPL_ACTION_PRODUCTS'),
    'TYPE' => 'LIST',
    'MULTIPLE' => 'Y',
    'DEFAULT' => 'ADMIN',
...
$arTemplateParameters['FILL_ITEM_ALL_PRICES'] = array(
    'PARENT' => 'PRICES',
    'NAME' => GetMessage('CP_BC_TPL_FILL_ITEM_ALL_PRICES'),
    'TYPE' => 'CHECKBOX',
    'MULTIPLE' => 'N',
    'REFRESH' => 'N',
    'DEFAULT' => 'N'
