...
return [
	'block' =>
		[
			'name' => \Bitrix\Main\Localization\Loc::getMessage('BLOG_TITLE_IMAGES_AND_LIST_RIGHT'),
			'section' => 'blog',
		],
    'fields' =>
		[
	...
	'ext' =>
		[
			...
			'css' =>
				[$_SERVER['DOCUMENT_ROOT'].'/local/templates/.default/components/bitrix/news.list/origami_blog_images_and_list_right/style.css'
				],
		],
	'style'  =>
		[
