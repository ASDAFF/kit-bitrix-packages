...
return [
	'block' =>
		[
			'name' => \Bitrix\Main\Localization\Loc::getMessage('NEWS_TITLE_IMAGES_AND_LIST'),
			'section' => 'news',
		],
    'fields' =>
		[
	...
	'ext' =>
		[
			...
			'css' =>
				[$_SERVER['DOCUMENT_ROOT'].'/local/templates/.default/components/bitrix/news.list/origami_news_images_and_list/style.css'
				],
		],
	'style'  =>
		[
