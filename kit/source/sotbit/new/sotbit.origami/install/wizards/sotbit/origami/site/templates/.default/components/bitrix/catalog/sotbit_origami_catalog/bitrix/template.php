...
$this->SetViewTarget('section_img');
...
$this->EndViewTarget();
$this->SetViewTarget('section_desc');
if ($arParams['HIDE_SECTION_DESCRIPTION'] !== 'Y')
{
	?>
	<div class="catalog_content__category_comment fonts__main_comment">
...
?>
	...
	<div class="tabs_block__product_card" data-entity="<?=$containerName?>">
		<?
		if($arResult['ITEMS'])
		{
			foreach($arResult['ITEMS'] as $item)
			{
				...
				product_card__block_item-<?=$arParams['LINE_ELEMENT_COUNT']?>">
					<?
