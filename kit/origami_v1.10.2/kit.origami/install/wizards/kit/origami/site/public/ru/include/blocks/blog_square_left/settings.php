...
return [
	'block' =>
		[
			'name' => \Bitrix\Main\Localization\Loc::getMessage('BLOG_TITLE_SQUARE_LEFT'),
			'section' => 'blog',
		],
    'fields' =>
		[
	...
	'ext' =>
		[
			...
			'css' =>
				[$_SERVER['DOCUMENT_ROOT'].'/local/templates/.default/components/bitrix/news.list/origami_blog_square_left/style.css',
				],
		],
	'style'  =>
		[
