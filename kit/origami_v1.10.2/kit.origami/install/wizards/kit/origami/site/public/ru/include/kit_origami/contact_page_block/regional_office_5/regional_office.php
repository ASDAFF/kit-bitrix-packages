...
Asset::getInstance()->addjs(SITE_DIR . "local/templates/kit_origami/assets/plugin/fix-block/script.js");
                                                    ...
                                                    <div class="office-image-address-wrapper">
                                                        <div class="office-image">
                                                            ...
                                                            if ($pathImg) {
                                                                ...
                                                                ?>
                                                                <img
                                                                    src="<?= SITE_DIR ?>include/kit_origami/contact_page_block/regional_office/default-no-photo.jpg"
                                                                    alt="">
                                                                <?
                                                            }
                                                            ?>
