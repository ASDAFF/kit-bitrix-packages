...
if(0 && $arResult["MEDIA"] && $arParams["IMG_DEFAULT"] == 'Y')
{
    foreach($arResult["MEDIA"] as $key => $media)
    {
        ...
        if($key == 2)
        {
            $tempFile_430 = $_SERVER['DOCUMENT_ROOT'].'/upload/kit.instagram/430/' . $key . '/' . $arResult["LOGIN"]. '.jpg';
            ...
            $tempFile_200 = $_SERVER['DOCUMENT_ROOT'].'/upload/kit.instagram/200/' . $key . '/' . $arResult["LOGIN"]. '.jpg';
