...
<div class="puzzle_block main-container">
	...
	<div id="social_block_YT_<?=$idItem?>" class="social_block_YT swiper-container">
		<div class="social_block_YT__wrapper swiper-wrapper">
            <?
            if($arResult["VIDEOS"])
            {
                ...
                {
                    echo '
                        <div class="social_block_YT__item swiper-slide">
                          <div class="video">
...
<script>
    const social_block_YT_<?=$idItem?> = new CreateSlider ({
        sliderContainer: '#social_block_YT_<?=$idItem?>',
        sizeSliderInit: 768
    });
</script>
